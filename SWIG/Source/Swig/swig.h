...
extern Node   *Swig_symbol_lookup(String_or_char *symname, Symtab *tab);
extern Symtab *Swig_symbol_scope_lookup(String_or_char *symname, Symtab *tab);
extern Node   *Swig_symbol_lookup_local(String_or_char *symname, Symtab *tab);
