...
for s in lines:
    ...
    if m:
        ...
        result.append("""<H1><a name="%s">%s</a></H1>""" % (headingname,prevheadingtext))
        result.append("@INDEX@")
        section = 0
        subsection = 0
        subsubsection = 0
    ...
    if m:
        ...
        section += 1
        headingname = getheadingname(m)
        result.append("""<H2><a name="%s">%s</a></H2>""" % (headingname,prevheadingtext))
    ...
    if m:
        ...
        subsection += 1
        headingname = getheadingname(m)
        result.append("""<H3><a name="%s">%s</a></H3>""" % (headingname,prevheadingtext))
    ...
    if m:
        ...
        headingname = getheadingname(m)
        result.append("""<H4><a name="%s">%s</a></H4>""" % (headingname,prevheadingtext))
    ...
    if m:
        ...
        subsubsubsection += 1
        headingname = getheadingname(m)
        result.append("""<H5><a name="%s">%s</a></H5>""" % (headingname,prevheadingtext))
