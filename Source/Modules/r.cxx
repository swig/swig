...
int R::top(Node *n) {
  ...
  /* R does not allow package names to have '_' in the name
     we simply replace all occurrences of '_' with '.' */
  Replace(Rpackage, "_", ".", DOH_REPLACE_ANY);
  if(!DllName)
    DllName = Copy(Rpackage);
