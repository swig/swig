...
void CSharpDocConverter::fillStaticTables() {
  ...
  tagHandlers["attention"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["author"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["authors"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["brief"] = make_handler(&CSharpDocConverter::handleParagraph, "para");
  tagHandlers["bug"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["code"] = make_handler(&CSharpDocConverter::handleCode);
  tagHandlers["copyright"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["date"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["deprecated"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["details"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["em"] = make_handler(&CSharpDocConverter::handleTagWrap, "*");
  tagHandlers["example"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["exception"] = tagHandlers["throw"] = tagHandlers["throws"] = make_handler(&CSharpDocConverter::handleTagException);
  tagHandlers["htmlonly"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["invariant"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["latexonly"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["link"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["manonly"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["note"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["p"] = make_handler(&CSharpDocConverter::handleTagWrap, "``");
  tagHandlers["partofdescription"] = make_handler(&CSharpDocConverter::handleSummary);
  tagHandlers["rtfonly"] = make_handler(&CSharpDocConverter::handleParagraph);
  ...
  tagHandlers["since"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["short"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["todo"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["version"] = make_handler(&CSharpDocConverter::handleParagraph);
  tagHandlers["verbatim"] = make_handler(&CSharpDocConverter::handleVerbatimBlock);
  tagHandlers["warning"] = make_handler(&CSharpDocConverter::handleParagraph, "remarks");
  tagHandlers["xmlonly"] = make_handler(&CSharpDocConverter::handleParagraph);
...
void CSharpDocConverter::handleTagPar(DoxygenEntity &tag, std::string &translatedComment, const std::string &) {
