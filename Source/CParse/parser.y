...
c_decl  : attribute[decl_attr] storage_class type declarator cpp_const attribute[type_attr] initializer c_decl_tail {
	   ...
	   | attribute storage_class AUTO idcolon EQUAL error SEMI {
...
anonymous_bitfield :  attribute storage_class anon_bitfield_type COLON expr SEMI { Delete($storage_class); };
