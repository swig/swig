 ...
 *
 * Return the package string containing the revision number (git commit hash and time)
 * ----------------------------------------------------------------------------- */

const char *Swig_package_revision(void) {
  return 
...
void Swig_banner_target_lang(File *f, const_String_or_char_ptr commentchar) {
  ...
  Printf(f, "%s Revision %s\n", commentchar, Swig_package_revision());
  Printf(f, "%s\n", commentchar);
