...
void SwigDirector_Callback::run() {
  ...
  typedef void (*SWIG_ObjCMsgSend_swig_override_run__ffF__t)(SWIGObjectiveCId, SEL);
  ((SWIG_ObjCMsgSend_swig_override_run__ffF__t)objc_msgSend)(swig_objc_self, @selector(run));
  return;
}
