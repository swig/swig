...
program fortran_funptr_runme
  ...
  write(*,*) "SWIG-wrapped C function:", add(a,b)
  write(*,*) "SWIG-wrapped C function pointer:", do_op(a,b,add_fp)
  ...
  call c_f_procpointer(add_fp, my_ffunc)
