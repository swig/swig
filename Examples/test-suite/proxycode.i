...
#else
%proxycode %{
  fun proxycode5(i: $typemap(jstype, T)): $typemap(jstype, T) {
    return i;
  }
%}
#endif
...
%proxycode %{
  fun proxyUseT(t1: Long, t2: Long): $javaclassname {
    val tt1: $typemap(jstype, unsigned int) = t1
    val tt2: $typemap(jstype, unsigned int const&) = t2
