...
#include "conversion_namespace_wrap.h"
...
void* _wrap_Bar_toFoo(void* imarg1)
{
  ...
  arg1 = (oss::Bar *)imarg1; 
  result = (arg1)->operator oss::Foo();
  
  temp = new oss::Foo((const oss::Foo &)result);
  imresult = (void*)temp;
