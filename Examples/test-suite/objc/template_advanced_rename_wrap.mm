...
int _wrap_funky_int(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
  int imresult = 0 ;
  ...
  arg1 = (int)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)Quirky::SWIGTEMPLATEDISAMBIGUATOR funky< int >(arg1,arg2);
  imresult = result; 
  return imresult;
}

void _wrap_funky_void()
{
  Quirky::SWIGTEMPLATEDISAMBIGUATOR funky< int >();
}

double _wrap_funky_double(double imarg1, double imarg2)
{
  double arg1 ;
  double arg2 ;
  double imresult = 0 ;
  ...
  arg1 = (double)imarg1; 
  arg2 = (double)imarg2; 
  result = (double)Quirky::SWIGTEMPLATEDISAMBIGUATOR funky< double >(arg1,arg2);
  imresult = result; 
  return imresult;
}

void _wrap_Funky_NoParms()
{
  Quirky::SWIGTEMPLATEDISAMBIGUATOR funky< double >();
}

BOOL _wrap_FUNKY(BOOL imarg1, BOOL imarg2)
{
  bool arg1 ;
  bool arg2 ;
  BOOL imresult = 0 ;
  ...
  result = (bool)Quirky::SWIGTEMPLATEDISAMBIGUATOR funky< bool >(arg1,arg2);
  imresult = (result)? YES:NO; 
  return imresult;
}

int _wrap_Goose(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)Golden::SWIGTEMPLATEDISAMBIGUATOR goose< int >(arg1);
  imresult = result; 
  return imresult;
}

BOOL _wrap_Golden_goose(BOOL imarg1)
{
  bool arg1 ;
  BOOL imresult = 0 ;
  bool result;
  ...
  arg1 = imarg1? true : false; 
  result = (bool)Golden::SWIGTEMPLATEDISAMBIGUATOR goose< bool >(arg1);
  imresult = (result)? YES:NO; 
  return imresult;
}
