...
NSString * _wrap_Foob_bar(void* imarg1, void* imarg2)
{
  Bar *temp2 = 0 ;
  Foo< Bar const * > *arg1 = 0 ;
  Bar **arg2 = 0 ;
  NSString * imresult = 0 ;
  Bar *temp20 = 0 ;
  char *result = 0 ;
  
  arg1 = (Foo< Bar const * > *)imarg1; 
  temp20 = *(Bar **)&imarg2;
  arg2 = (Bar **)&temp20; 
  result = (char *)(arg1)->bar((Bar const *const &)*arg2);
...
{
  void* imresult = 0 ;
  Foo< Bar const * > *result = 0 ;
  
  result = (Foo< Bar const * > *)new Foo< Bar const * >();
...
void _wrap_delete_Foob(void* imarg1)
{
  Foo< Bar const * > *arg1 = 0 ;
...
NSString * _wrap_Fooi_bar(void* imarg1, void* imarg2)
{
  int *temp2 = 0 ;
  Foo< int const * > *arg1 = 0 ;
  int **arg2 = 0 ;
  NSString * imresult = 0 ;
  int *temp20 = 0 ;
  char *result = 0 ;
  
  arg1 = (Foo< int const * > *)imarg1; 
  temp20 = *(int **)&imarg2;
  arg2 = (int **)&temp20; 
  result = (char *)(arg1)->bar((int const *const &)*arg2);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}
...
{
  void* imresult = 0 ;
  Foo< int const * > *result = 0 ;
  
  result = (Foo< int const * > *)new Foo< int const * >();
...
void _wrap_delete_Fooi(void* imarg1)
{
  Foo< int const * > *arg1 = 0 ;
