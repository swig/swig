...
SWIGINTERN std::vector< Wheel >::const_reference std_vector_Sl_Wheel_Sg__get(std::vector< Wheel > *self,int i){
...
SWIGINTERN void std_vector_Sl_Wheel_Sg__set(std::vector< Wheel > *self,int i,std::vector< Wheel >::value_type const &val){
                int size = int(self->size());
                if (i>=0 && i<size)
                    (*self)[i] = val;
                else
...
void _wrap_Wheel_size_set(void* imarg1, int imarg2)
{
  Wheel *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Wheel_size_get(void* imarg1)
{
  Wheel *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_Wheel(int imarg1)
{
  int arg1 ;
  void* imresult = 0 ;
  Wheel *result = 0 ;
...
void _wrap_delete_Wheel(void* imarg1)
{
  Wheel *arg1 = 0 ;
...
void* _wrap_new_VectorWheel()
{
  void* imresult = 0 ;
  std::vector< Wheel > *result = 0 ;
  
  result = (std::vector< Wheel > *)new std::vector< Wheel >();
...
unsigned long _wrap_VectorWheel_size(void* imarg1)
{
  std::vector< Wheel > *arg1 = 0 ;
  unsigned long imresult = 0 ;
  std::vector< Wheel >::size_type result;
  
  arg1 = (std::vector< Wheel > *)imarg1; 
  result = ((std::vector< Wheel > const *)arg1)->size();
  imresult = result; 
  return imresult;
}

unsigned long _wrap_VectorWheel_capacity(void* imarg1)
{
  std::vector< Wheel > *arg1 = 0 ;
  unsigned long imresult = 0 ;
  std::vector< Wheel >::size_type result;
  ...
  arg1 = (std::vector< Wheel > *)imarg1; 
  result = ((std::vector< Wheel > const *)arg1)->capacity();
  imresult = result; 
  return imresult;
}

void _wrap_VectorWheel_reserve(void* imarg1, unsigned long imarg2)
{
  std::vector< Wheel > *arg1 = 0 ;
  std::vector< Wheel >::size_type arg2 ;
  
  arg1 = (std::vector< Wheel > *)imarg1; 
  arg2 = (std::vector< Wheel >::size_type)imarg2; 
  (arg1)->reserve(SWIG_STD_MOVE(*(&arg2)));
}

BOOL _wrap_VectorWheel_isEmpty(void* imarg1)
{
  std::vector< Wheel > *arg1 = 0 ;
  BOOL imresult = 0 ;
  bool result;
  ...
  arg1 = (std::vector< Wheel > *)imarg1; 
  result = (bool)((std::vector< Wheel > const *)arg1)->empty();
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_VectorWheel_clear(void* imarg1)
{
  std::vector< Wheel > *arg1 = 0 ;
...
void _wrap_VectorWheel_add(void* imarg1, void* imarg2)
{
  std::vector< Wheel > *arg1 = 0 ;
  std::vector< Wheel >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< Wheel > *)imarg1; 
  arg2 = (std::vector< Wheel >::value_type *)imarg2; 
  (arg1)->push_back((std::vector< Wheel >::value_type const &)*arg2);
}

void* _wrap_VectorWheel_get(void* imarg1, int imarg2)
{
  std::vector< Wheel > *arg1 = 0 ;
  int arg2 ;
  void* imresult = 0 ;
  std::vector< Wheel >::value_type *result = 0 ;
  
  arg1 = (std::vector< Wheel > *)imarg1; 
  arg2 = (int)imarg2; 
  try {
    result = (std::vector< Wheel >::value_type *) &std_vector_Sl_Wheel_Sg__get(arg1,arg2);
...
void _wrap_VectorWheel_set(void* imarg1, int imarg2, void* imarg3)
{
  std::vector< Wheel > *arg1 = 0 ;
  int arg2 ;
  std::vector< Wheel >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< Wheel > *)imarg1; 
  arg2 = (int)imarg2; 
  arg3 = (std::vector< Wheel >::value_type *)imarg3; 
  try {
    std_vector_Sl_Wheel_Sg__set(arg1,arg2,(Wheel const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_ObjcThrowException(SWIG_ObjcIndexOutOfBoundsException, (&_e)->what());
    return ;
  }
...
void _wrap_delete_VectorWheel(void* imarg1)
{
  std::vector< Wheel > *arg1 = 0 ;
