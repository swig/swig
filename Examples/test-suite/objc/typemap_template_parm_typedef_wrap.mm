...
#define SWIGTYPE_p_unsigned_int swig_types[0]
...
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "jada::uint *|unsigned int *", 0, 0, (void*)0, 0};
...
void _wrap_test_no_typedef(void* imarg1)
{
  std::list< unsigned int > tmp1 ;
  std::list< jada::uint > arg1 ;
  std::list< unsigned int > tmp10 ;
  
  {
    arg1 = tmp10;
  }
  jada::test_no_typedef(SWIG_STD_MOVE(*(&arg1)));
}

void _wrap_test_typedef(void* imarg1)
{
  std::vector< unsigned int > tmp1 ;
  std::vector< jada::uint > arg1 ;
  std::vector< unsigned int > tmp10 ;
  
  {
    arg1 = tmp10;
  }
  jada::test_typedef(SWIG_STD_MOVE(*(&arg1)));
}

void* _wrap_no_typedef_out()
{
  void* imresult = 0 ;
  std::deque< unsigned int > result;
  
  result = jada::no_typedef_out();
  {
