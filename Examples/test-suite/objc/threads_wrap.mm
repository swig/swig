...
NSString* _wrap_Kerfuffle_StdString(void* imarg1, NSString* imarg2)
{
  Kerfuffle *arg1 = 0 ;
  std::string arg2 ;
  NSString* imresult = 0 ;
  ...
  result = (arg1)->StdString(SWIG_STD_MOVE(*(&arg2)));
  imresult = [NSString stringWithUTF8String: (&result)->c_str()]; 
  return imresult;
}

NSString * _wrap_Kerfuffle_CharString(void* imarg1, NSString * imarg2)
{
  Kerfuffle *arg1 = 0 ;
  char *arg2 = 0 ;
  NSString * imresult = 0 ;
  ...
  result = (char *)(arg1)->CharString((char const *)arg2);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  delete [] result;
  return imresult;
}

void* _wrap_new_Kerfuffle()
{
  void* imresult = 0 ;
  Kerfuffle *result = 0 ;
  
  result = (Kerfuffle *)new Kerfuffle();
...
void _wrap_delete_Kerfuffle(void* imarg1)
{
  Kerfuffle *arg1 = 0 ;
