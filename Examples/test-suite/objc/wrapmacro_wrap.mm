...
guint16 SWIGMACRO_GUINT16_SWAP_LE_BE_CONSTANT(guint16 val) {
  return GUINT16_SWAP_LE_BE_CONSTANT(val);
}


size_t SWIGMACRO_maximum(size_t a,const size_t& b) {
  return maximum(a,b);
}


double SWIGMACRO_maximum(double a,double b) {
  return maximum(a,b);
}
...
static swig_type_info _swigt__p_unsigned_short = {"_p_unsigned_short", "guint16 *|unsigned short *", 0, 0, (void*)0, 0};
...
unsigned short _wrap_GUINT16_SWAP_LE_BE_CONSTANT(unsigned short imarg1)
{
  guint16 arg1 ;
  ...
  arg1 = (guint16)imarg1; 
  result = (guint16)SWIGMACRO_GUINT16_SWAP_LE_BE_CONSTANT(arg1);
  imresult = result; 
  return imresult;
}

unsigned long _wrap_maximum(unsigned long imarg1, unsigned long  * imarg2)
{
  size_t arg1 ;
  size_t *arg2 = 0 ;
  ...
  arg1 = (size_t)imarg1; 
  arg2 = (size_t *)imarg2; 
  result = SWIGMACRO_maximum(SWIG_STD_MOVE(*(&arg1)),(size_t const &)*arg2);
  imresult = result; 
  return imresult;
}
