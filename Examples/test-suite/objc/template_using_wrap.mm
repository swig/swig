...
int _wrap_maxint(int imarg1, int imarg2)
{
  ...
  arg1 = (int)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)foo::SWIGTEMPLATEDISAMBIGUATOR maxk< int >(arg1,arg2);
  imresult = result; 
  return imresult;
}

void* _wrap_new_Foofloat()
{
  void* imresult = 0 ;
  foo::Foo< float > *result = 0 ;
  
  result = (foo::Foo< float > *)new foo::Foo< float >();
...
void _wrap_delete_Foofloat(void* imarg1)
{
  foo::Foo< float > *arg1 = 0 ;
  
  arg1 = (foo::Foo< float > *)imarg1; 
  delete arg1;
}

float _wrap_maxfloat(float imarg1, float imarg2)
{
  float arg1 ;
  float arg2 ;
  float imresult = 0 ;
  ...
  arg1 = (float)imarg1; 
  arg2 = (float)imarg2; 
  result = (float)foo::SWIGTEMPLATEDISAMBIGUATOR maxk< float >(arg1,arg2);
  imresult = result; 
  return imresult;
}
