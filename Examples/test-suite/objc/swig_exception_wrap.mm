...
void* _wrap_new_Value(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
  void* imresult = 0 ;
  ...
  {
    try {
      result = (Value *)new Value(arg1,arg2);
...
void _wrap_delete_Value(void* imarg1)
{
  Value *arg1 = 0 ;
...
void* _wrap_Shape_throwException(void* imarg1)
{
  Shape *arg1 = 0 ;
  void* imresult = 0 ;
  Value *temp ;
  SwigValueWrapper< Value > result;
  
  arg1 = (Shape *)imarg1; 
  {
    try {
      result = (arg1)->throwException();
    } catch (std::exception& e) {
      SWIG_exception(SWIG_SystemError, e.what());
    }
  }
  
  temp = new Value((const Value &)result);
  imresult = (void*)temp;
