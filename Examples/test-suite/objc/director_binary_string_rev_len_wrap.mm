...
public:
  ...
  bool swig_override_run__ffint_p_charF_;
  virtual int run(int sizeAA,char *dataBufferAA);
};
...
int SwigDirector_Callback::run(int sizeAA,char *dataBufferAA) {
  int c_result = SwigValueInit< int >() ;
  int objc_result ;
  
  if (!swig_objc_self || !swig_override_run__ffint_p_charF_) {
    return Callback::run(sizeAA,dataBufferAA);
  }
  typedef int (*SWIG_ObjCMsgSend_swig_override_run__ffint_p_charF__t)(SWIGObjectiveCId, SEL, int, NSString *);
  objc_result = ((SWIG_ObjCMsgSend_swig_override_run__ffint_p_charF__t)objc_msgSend)(swig_objc_self, @selector(run:dataBufferAA:), sizeAA, dataBufferAA ? [NSString stringWithUTF8String:(const char *)dataBufferAA] : 0);
...
void SwigDirector_Callback::swig_connect_director(SWIGObjectiveCId obj) {
  ...
  swig_override_run__ffint_p_charF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(run:dataBufferAA:));
}
...
int _wrap_Callback_run(void* imarg1, int imarg2, NSString * imarg3)
{
  ...
  if (upcall) {
    result = (int)(arg1)->Callback::run(arg2,arg3);
  } else {
