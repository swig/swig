...
void* _wrap_MotorCar_WindScreenOpinion(void* imarg1)
{
  MotorCar *arg1 = 0 ;
  void* imresult = 0 ;
  std::string *temp ;
  ...
  arg1 = (MotorCar *)imarg1; 
  result = (arg1)->WindScreenOpinion();
...
void* _wrap_new_MotorCar()
{
  void* imresult = 0 ;
  MotorCar *result = 0 ;
  
  result = (MotorCar *)new MotorCar();
...
void _wrap_delete_MotorCar(void* imarg1)
{
  MotorCar *arg1 = 0 ;
