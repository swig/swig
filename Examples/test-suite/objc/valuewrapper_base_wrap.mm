...
#define SWIGTYPE_p_oss__Base swig_types[0]
#define SWIGTYPE_p_oss__Interface_T_oss__BinaryPolarization_t swig_types[1]
...
static void *_p_oss__Interface_T_oss__BinaryPolarization_tTo_p_oss__Base(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((oss::Base *)  ((oss::Interface_< oss::BinaryPolarization > *) x));
}
static swig_type_info _swigt__p_oss__Base = {"_p_oss__Base", "oss::Base *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_oss__Interface_T_oss__BinaryPolarization_t = {"_p_oss__Interface_T_oss__BinaryPolarization_t", 0, 0, 0, 0, 0};
...
static swig_cast_info _swigc__p_oss__Interface_T_oss__BinaryPolarization_t[] = {{&_swigt__p_oss__Interface_T_oss__BinaryPolarization_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_oss__Base[] = {  {&_swigt__p_oss__Base, 0, 0, 0},  {&_swigt__p_oss__Interface_T_oss__BinaryPolarization_t, _p_oss__Interface_T_oss__BinaryPolarization_tTo_p_oss__Base, 0, 0},{0, 0, 0, 0}};
...
void _wrap_delete_Base(void* imarg1)
{
  ...
  arg1 = (oss::Base *)imarg1; 
  delete arg1;
}

void* _wrap_new_Interface_BP(void* imarg1)
{
  oss::Base *arg1 = 0 ;
  void* imresult = 0 ;
  ...
  arg1 = (oss::Base *)imarg1; 
  result = (oss::Interface_< oss::BinaryPolarization > *)new oss::Interface_< oss::BinaryPolarization >((oss::Base const &)*arg1);
...
void* SWIG_ObjectiveC_cast__p_oss__Interface_T_oss__BinaryPolarization_t_to__p_oss__Base(void* imarg1) {
#ifdef __cplusplus
  return (void*)((oss::Base *)((oss::Interface_< oss::BinaryPolarization > *)imarg1));
#else
  return imarg1;
#endif
}
void* _wrap_make_Interface_BP()
{
  void* imresult = 0 ;
  oss::Interface_< oss::BinaryPolarization > *temp ;
  SwigValueWrapper< oss::Interface_< oss::BinaryPolarization > > result;
  
  result = oss::SWIGTEMPLATEDISAMBIGUATOR make< oss::Interface_< oss::BinaryPolarization > >();
  
  temp = new oss::Interface_< oss::BinaryPolarization >((const oss::Interface_< oss::BinaryPolarization > &)result);
  imresult = (void*)temp;
