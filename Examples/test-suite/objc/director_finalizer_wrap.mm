...
public:
  ...
  bool swig_override_orStatus__ffintF_;
...
void SwigDirector_Foo::orStatus(int x) {
  if (!swig_objc_self || !swig_override_orStatus__ffintF_) {
    Foo::orStatus(x);
    return;
  }
  typedef void (*SWIG_ObjCMsgSend_swig_override_orStatus__ffintF__t)(SWIGObjectiveCId, SEL, int);
  ((SWIG_ObjCMsgSend_swig_override_orStatus__ffintF__t)objc_msgSend)(swig_objc_self, @selector(orStatus:), x);
  return;
}
...
void SwigDirector_Foo::swig_connect_director(SWIGObjectiveCId obj) {
  ...
  swig_override_orStatus__ffintF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(orStatus:));
}
...
void _wrap_Foo_orStatus(void* imarg1, int imarg2)
{
  Foo *arg1 = 0 ;
  int arg2 ;
  bool upcall = false;
...
void _wrap_deleteFoo(void* imarg1)
{
  Foo *arg1 = 0 ;
