...
#define SWIGTYPE_p_ExtendBase swig_types[0]
#define SWIGTYPE_p_ExtendDerived swig_types[1]
...
SWIGINTERN void ExtendDerived_one(ExtendDerived *self){ self->ExtendBase::one(); }
...
static void *_p_ExtendDerivedTo_p_ExtendBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((ExtendBase *)  ((ExtendDerived *) x));
}
static swig_type_info _swigt__p_ExtendBase = {"_p_ExtendBase", "ExtendBase *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ExtendDerived = {"_p_ExtendDerived", 0, 0, 0, 0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ExtendBase,
  &_swigt__p_ExtendDerived,
};

static swig_cast_info _swigc__p_ExtendDerived[] = {{&_swigt__p_ExtendDerived, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ExtendBase[] = {  {&_swigt__p_ExtendBase, 0, 0, 0},  {&_swigt__p_ExtendDerived, _p_ExtendDerivedTo_p_ExtendBase, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ExtendBase,
  _swigc__p_ExtendDerived,
};


/* -------- TYPE CONVERSION AND EQUIVALENCE RULES (END) -------- */

void _wrap_ExtendDerived_two(void* imarg1)
{
  ExtendDerived *arg1 = 0 ;
  
  arg1 = (ExtendDerived *)imarg1; 
  (arg1)->two();
}

void _wrap_ExtendDerived_three(void* imarg1)
{
  ExtendDerived *arg1 = 0 ;
...
void _wrap_ExtendDerived_one(void* imarg1)
{
  ExtendDerived *arg1 = 0 ;
  
  arg1 = (ExtendDerived *)imarg1; 
  ExtendDerived_one(arg1);
}

void* _wrap_new_ExtendDerived()
{
  void* imresult = 0 ;
  ExtendDerived *result = 0 ;
  
  result = (ExtendDerived *)new ExtendDerived();
...
void _wrap_delete_ExtendDerived(void* imarg1)
{
  ExtendDerived *arg1 = 0 ;
