...
void _wrap_A_k_set(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
...
int _wrap_A_g(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
...
unsigned char _wrap_LASTCHAR1_get()
{
  unsigned char imresult = 0 ;
  unsigned char result;
  
  result = (unsigned char)(unsigned char)LASTCHAR1;
  imresult = result; 
  return imresult;
}

unsigned char _wrap_LASTCHAR2_get()
{
  unsigned char imresult = 0 ;
  unsigned char result;
  
  result = (unsigned char)(unsigned char)LASTCHAR2;
  imresult = result; 
  return imresult;
}
