...
SWIGINTERN int Foo_test__SWIG_0(Foo *self){ return 0; }

typedef struct {
  int variable;
} Bar;

SWIGINTERN Bar *new_Bar(){
    return new Bar();
  }
...
void _wrap_Foo_variable_set(void* imarg1, int imarg2)
{
  Foo *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Foo_variable_get(void* imarg1)
{
  Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void _wrap_Bar_variable_set(void* imarg1, int imarg2)
{
  Bar *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Bar_variable_get(void* imarg1)
{
  Bar *arg1 = 0 ;
  int imresult = 0 ;
  int result;
