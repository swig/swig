...
static int check_direction(int x) {
    static  int values[] = { UP,DOWN,LEFT,RIGHT };
...
int _wrap_move(int imarg1)
{
  ...
  arg1 = (int)imarg1; 
  SWIG_contract_assert(0, (check_direction(arg1)), "Contract violation: require: (check_direction(arg1))");
  
  result = (int)move(arg1);
  imresult = result; 
  return imresult;
}
