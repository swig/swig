...
#include "cplusplus_throw_wrap.h"
...
void _wrap_Bar_baz(void* imarg1)
{
  Bar *arg1 = 0 ;
...
void _wrap_Bar_foo(void* imarg1)
{
  Bar *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Foo exception thrown");
    return ; 
  }
}

void _wrap_Bar_bazfoo(void* imarg1)
{
  Bar *arg1 = 0 ;
  
  arg1 = (Bar *)imarg1; 
  try {
    ((Bar const *)arg1)->bazfoo();
  } catch(int &_e) {
    char error_msg[256];
