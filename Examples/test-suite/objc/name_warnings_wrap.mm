...
#define SWIGTYPE_p_complex swig_types[2]
...
static swig_type_info _swigt__p_complex = {"_p_complex", "None *|complex *", 0, 0, (void*)0, 0};
...
void* _wrap_A_clone(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
  void* imresult = 0 ;
...
int _wrap_max_i(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
  int imresult = 0 ;
...
double _wrap_foo(double imarg1, double imarg2)
{
  double arg1 ;
  double arg2 ;
  double imresult = 0 ;
  ...
  arg1 = (double)imarg1; 
  arg2 = (double)imarg2; 
  result = (double)foo(arg1,arg2);
  imresult = result; 
  return imresult;
}

double _wrap_bar(double imarg1, BOOL imarg2)
{
  double arg1 ;
  bool arg2 ;
  double imresult = 0 ;
  ...
  result = (double)bar(arg1,arg2);
  imresult = result; 
  return imresult;
}

int _wrap_double_an_int(int imarg1)
{
  Foo< int >::value_type arg1 ;
  int imresult = 0 ;
  int result;
  
  arg1 = (Foo< int >::value_type)imarg1; 
  result = (int)double_an_int(arg1);
  imresult = result; 
  return imresult;
}
