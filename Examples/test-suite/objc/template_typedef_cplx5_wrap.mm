...
#define SWIGTYPE_p_std__complexT_double_t swig_types[0]
...
void* _wrap_A_test1(void* imarg1)
{
  A *arg1 = 0 ;
  void* imresult = 0 ;
  complex *temp ;
  ...
  temp = new complex((const complex &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_A_test2(void* imarg1)
{
  A *arg1 = 0 ;
  void* imresult = 0 ;
  ...
  temp = new std::complex< double >((const std::complex< double > &)result);
  imresult = (void*)temp;
