...
void _wrap_Foo__val_set(void* imarg1, int imarg2)
{
  Foo *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Foo__val_get(void* imarg1)
{
  Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_Foo_getVal(void* imarg1)
{
  Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_Foo_ptr(void* imarg1, BOOL imarg2)
{
  Foo *arg1 = 0 ;
  bool arg2 ;
  void* imresult = 0 ;
...
void* _wrap_Foo_ptr_getPtr()
{
  ...
  temp = new Foo_ptr((const Foo_ptr &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_Foo_ptr_getConstPtr()
{
  void* imresult = 0 ;
  Foo_ptr const *temp ;
  SwigValueWrapper< Foo_ptr > result;
...
void* _wrap_Foo_ptr___deref__(void* imarg1)
{
  Foo_ptr *arg1 = 0 ;
  void* imresult = 0 ;
  Foo *result = 0 ;
...
void* _wrap_copy_Foo_ptr(void* imarg1)
{
  Foo_ptr *arg1 = 0 ;
  void* imresult = 0 ;
  Foo_ptr *result = 0 ;
...
void _wrap_delete_Foo_ptr(void* imarg1)
{
  Foo_ptr *arg1 = 0 ;
...
int _wrap_Foo_ptr__val_get(void* imarg1)
{
  Foo_ptr *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_Foo_ptr_getVal(void* imarg1)
{
  Foo_ptr *arg1 = 0 ;
  int imresult = 0 ;
  int result;
