...
#include "function_typedef_wrap.h"
...
static swig_type_info _swigt__p_f_int_int__int = {"_p_f_int_int__int", "binop_t *|int (*)(int,int)", 0, 0, (void*)0, 0};
...
int _wrap_do_binop1(void* imarg1, int imarg2, int imarg3)
{
  binop_t *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg2 = (int)imarg2; 
  arg3 = (int)imarg3; 
  result = (int)do_binop1(arg1,arg2,arg3);
  imresult = result; 
  return imresult;
}

int _wrap_do_binop2(void* imarg1, int imarg2, int imarg3)
{
  binop_t *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg2 = (int)imarg2; 
  arg3 = (int)imarg3; 
  result = (int)do_binop2(arg1,arg2,arg3);
  imresult = result; 
  return imresult;
}

int _wrap_do_binop3(void* imarg1, int imarg2, int imarg3)
{
  int (*arg1)(int,int) = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg2 = (int)imarg2; 
  arg3 = (int)imarg3; 
  result = (int)do_binop3(arg1,arg2,arg3);
  imresult = result; 
  return imresult;
}
