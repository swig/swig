...
SWIGINTERN int Foo_test__SWIG_0(struct Foo *self,int x){ x = 0; return 1; }
...
void _wrap_Foo_dummy_set(void* imarg1, int imarg2)
{
  struct Foo *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Foo_dummy_get(void* imarg1)
{
  struct Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_Foo_test(void* imarg1, int imarg2)
{
  ...
  arg1 = (struct Foo *)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)Foo_test__SWIG_0(arg1,arg2);
  imresult = result; 
  return imresult;
}
