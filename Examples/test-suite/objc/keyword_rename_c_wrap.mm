...
int _wrap_implements(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
...
int _wrap_synchronized(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
...
void _wrap_stackalloc_i_set(void* imarg1, int imarg2)
{
  struct stackalloc *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct stackalloc *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1) (arg1)->i = arg2;
}

int _wrap_stackalloc_i_get(void* imarg1)
{
  struct stackalloc *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_stackalloc()
{
  void* imresult = 0 ;
  struct stackalloc *result = 0 ;
  
  result = (struct stackalloc *)calloc(1, sizeof(struct stackalloc));
...
void _wrap_delete_stackalloc(void* imarg1)
{
  struct stackalloc *arg1 = 0 ;
...
int _wrap__instanceof(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)instanceof(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_finally(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)finally(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_yield(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)yield(arg1);
  imresult = result; 
  return imresult;
}

void _wrap_S_yield_set(void* imarg1, int imarg2)
{
  struct S *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct S *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1) (arg1)->yield = arg2;
}

int _wrap_S_yield_get(void* imarg1)
{
  struct S *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_S()
{
  ...
  result = (struct S *)calloc(1, sizeof(struct S));
...
void* _wrap_make_S_with_yield(int imarg1)
{
  int arg1 ;
  void* imresult = 0 ;
  struct S *temp ;
  ...
  arg1 = (int)imarg1; 
  result = make_S_with_yield(arg1);
  {
    struct S * resultptr = (struct S *) malloc(sizeof(struct S));
    memmove(resultptr, &result, sizeof(struct S));
    temp = resultptr;
    imresult = (void*)temp;
  }
  return imresult;
