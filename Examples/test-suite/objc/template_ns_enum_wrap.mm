...
{
  void* imresult = 0 ;
  hello::traits< hello::Hi >::value_type *temp ;
  SwigValueWrapper< hello::traits< hello::Hi >::value_type > result;
  
  result = hello::say_hi();
  
  temp = new hello::traits< hello::Hi >::value_type((const hello::traits< hello::Hi >::value_type &)result);
  imresult = (void*)temp;
