...
void* _wrap_accumulate_integers()
{
  void* imresult = 0 ;
  int (*result)(std::vector< int >) = 0 ;
  
  result = (int (*)(std::vector< int >)) accumulate_integers;
...
int _wrap_MyC_take_function(void* imarg1, void* imarg2, void* imarg3)
{
  std::vector< int > *argp3 ;
  C< int (std::vector< int >) > *arg1 = 0 ;
  int (*arg2)(std::vector< int >) = 0 ;
  std::vector< int > arg3 ;
  int imresult = 0 ;
  std::vector< int > *argp30 ;
  int result;
  
  arg1 = (C< int (std::vector< int >) > *)imarg1; 
  arg2 = (int (*)(std::vector< int >))imarg2; 
  
  argp30 = (std::vector< int > *)imarg3;
  arg3 = *argp30;
  
  result = (int)(arg1)->take_function(arg2,SWIG_STD_MOVE(*(&arg3)));
  imresult = result; 
  return imresult;
}
...
{
  void* imresult = 0 ;
  C< int (std::vector< int >) > *result = 0 ;
  
  result = (C< int (std::vector< int >) > *)new C< int (std::vector< int >) >();
...
void _wrap_delete_MyC(void* imarg1)
{
  C< int (std::vector< int >) > *arg1 = 0 ;
