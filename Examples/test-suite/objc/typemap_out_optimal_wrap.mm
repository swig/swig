...
void* _wrap_copy_XX(void* imarg1)
{
  XX *arg1 = 0 ;
  void* imresult = 0 ;
  XX *result = 0 ;
  ...
  arg1 = (XX *)imarg1; 
  result = (XX *)new XX((XX const &)*arg1);
...
void* _wrap_XX_create()
{
  ...
  temp = new XX((const XX &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_XX_createConst()
{
  void* imresult = 0 ;
  XX const *temp ;
  XX result;
  
  result = XX::createConst();
...
void _wrap_XX_trace_set(BOOL imarg1)
{
  bool arg1 ;
...
BOOL _wrap_XX_trace_get()
{
  BOOL imresult = 0 ;
  bool result;
  
  result = (bool)XX::trace;
