...
#include "director_minimal_wrap.h"
...
class SwigDirector_Minimal : public Minimal {
public:
  void swig_connect_director(SWIGObjectiveCId obj);
  SWIGObjectiveCId swig_objc_self;
  SwigDirector_Minimal();
  bool swig_override_run__ffF_;
  virtual bool run() const;
    virtual ~SwigDirector_Minimal();
};

SwigDirector_Minimal::SwigDirector_Minimal() : Minimal() {
  swig_connect_director(0);
}

bool SwigDirector_Minimal::run() const {
  bool c_result = SwigValueInit< bool >() ;
  BOOL objc_result ;
  
  if (!swig_objc_self || !swig_override_run__ffF_) {
    return Minimal::run();
  }
  typedef BOOL (*SWIG_ObjCMsgSend_swig_override_run__ffF__t)(SWIGObjectiveCId, SEL);
  objc_result = ((SWIG_ObjCMsgSend_swig_override_run__ffF__t)objc_msgSend)(swig_objc_self, @selector(run));
  c_result = objc_result ? true : false; 
  return c_result;
}


SwigDirector_Minimal::~SwigDirector_Minimal() {
}

void SwigDirector_Minimal::swig_connect_director(SWIGObjectiveCId obj) {
  swig_objc_self = obj;
  Class actual_class = obj ? ((Class (*)(SWIGObjectiveCId))object_getClass)(obj) : 0;
  Class base_class = objc_getClass("Minimal");
  swig_override_run__ffF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(run));
}
...
#ifdef __cplusplus
  SwigDirector_Minimal *director = dynamic_cast<SwigDirector_Minimal *>((Minimal *)imarg1);
  if (director)
...
BOOL _wrap_Minimal_run(void* imarg1)
{
  ...
  arg1 = (Minimal *)imarg1; 
  if (upcall) {
    result = (bool)((Minimal const *)arg1)->Minimal::run();
  } else {
    result = (bool)((Minimal const *)arg1)->run();
  }
...
BOOL _wrap_Minimal_get(void* imarg1)
{
  ...
  arg1 = (Minimal *)imarg1; 
  result = (bool)((Minimal const *)arg1)->get();
  imresult = (result)? YES:NO; 
  return imresult;
}
...
void* _wrap_new_Minimal()
{
  ...
  result = (Minimal *)new SwigDirector_Minimal();
