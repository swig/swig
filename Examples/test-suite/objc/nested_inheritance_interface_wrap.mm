...
#define SWIGTYPE_p_B__N swig_types[0]
#define SWIGTYPE_p_IA swig_types[1]
...
static void *_p_B__NTo_p_IA(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((IA *)  ((B::N *) x));
}
static swig_type_info _swigt__p_IA = {"_p_IA", "IA *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_B__N = {"_p_B__N", 0, 0, 0, 0, 0};
...
static swig_cast_info _swigc__p_B__N[] = {{&_swigt__p_B__N, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_IA[] = {  {&_swigt__p_IA, 0, 0, 0},  {&_swigt__p_B__N, _p_B__NTo_p_IA, 0, 0},{0, 0, 0, 0}};
...
void* SWIG_ObjectiveC_cast__p_B__N_to__p_IA(void* imarg1) {
#ifdef __cplusplus
  return (void*)((IA *)((B::N *)imarg1));
#else
  return imarg1;
#endif
}
