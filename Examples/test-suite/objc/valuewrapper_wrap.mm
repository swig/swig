...
void _wrap_delete_Xi(void* imarg1)
{
  X< int > *arg1 = 0 ;
...
int _wrap_YXi_spam(void* imarg1, void* imarg2)
{
  X< int > *argp2 ;
  Y< X< int > > *arg1 = 0 ;
  SwigValueWrapper< X< int > > arg2 ;
  int imresult = 0 ;
  X< int > *argp20 ;
  int result;
  ...
  result = (int)(arg1)->spam(SWIG_STD_MOVE(*(&arg2)));
  imresult = result; 
  return imresult;
}

void _wrap_delete_YXi(void* imarg1)
{
  Y< X< int > > *arg1 = 0 ;
