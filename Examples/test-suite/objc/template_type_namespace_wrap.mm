...
unsigned long _wrap_string_vector_size(void* imarg1)
{
...
unsigned long _wrap_string_vector_capacity(void* imarg1)
{
  std::vector< std::string > *arg1 = 0 ;
  unsigned long imresult = 0 ;
  std::vector< std::string >::size_type result;
...
void _wrap_string_vector_reserve(void* imarg1, unsigned long imarg2)
{
  std::vector< std::string > *arg1 = 0 ;
...
BOOL _wrap_string_vector_isEmpty(void* imarg1)
{
  std::vector< std::string > *arg1 = 0 ;
  BOOL imresult = 0 ;
  bool result;
...
void _wrap_string_vector_clear(void* imarg1)
{
  std::vector< std::string > *arg1 = 0 ;
...
void _wrap_string_vector_add(void* imarg1, NSString* imarg2)
{
  std::vector< std::string > *arg1 = 0 ;
...
NSString* _wrap_string_vector_get(void* imarg1, int imarg2)
{
  std::vector< std::string > *arg1 = 0 ;
  int arg2 ;
  NSString* imresult = 0 ;
...
void _wrap_string_vector_set(void* imarg1, int imarg2, NSString* imarg3)
{
  std::vector< std::string > *arg1 = 0 ;
  int arg2 ;
...
void _wrap_delete_string_vector(void* imarg1)
{
  std::vector< std::string > *arg1 = 0 ;
