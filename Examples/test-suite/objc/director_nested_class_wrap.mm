...
int _wrap_DirectorOuter_callMethod(void* imarg1, int imarg2)
{
  DirectorOuter::DirectorInner *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
  int result;
  
  arg1 = (DirectorOuter::DirectorInner *)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)DirectorOuter::callMethod((DirectorOuter::DirectorInner const &)*arg1,arg2);
  imresult = result; 
  return imresult;
}

int _wrap_DirectorOuter_callInnerInnerMethod(void* imarg1, int imarg2)
{
  DirectorOuter::DirectorInner::DirectorInnerInner *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
  int result;
  
  arg1 = (DirectorOuter::DirectorInner::DirectorInnerInner *)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)DirectorOuter::callInnerInnerMethod((DirectorOuter::DirectorInner::DirectorInnerInner const &)*arg1,arg2);
  imresult = result; 
  return imresult;
}

void* _wrap_new_DirectorOuter()
{
  void* imresult = 0 ;
  DirectorOuter *result = 0 ;
  
  result = (DirectorOuter *)new DirectorOuter();
...
void _wrap_delete_DirectorOuter(void* imarg1)
{
  DirectorOuter *arg1 = 0 ;
  
  arg1 = (DirectorOuter *)imarg1; 
  delete arg1;
}
