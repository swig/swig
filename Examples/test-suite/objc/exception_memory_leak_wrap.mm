...
#include "exception_memory_leak_wrap.h"
...
unsigned int _wrap_Foo_get_count()
{
  unsigned int imresult = 0 ;
  unsigned int result;
  
  result = (unsigned int)Foo::get_count();
  imresult = result; 
  return imresult;
}

unsigned int _wrap_Foo_get_freearg_count()
{
  unsigned int imresult = 0 ;
  unsigned int result;
  
  result = (unsigned int)Foo::get_freearg_count();
  imresult = result; 
  return imresult;
}

void* _wrap_trigger_internal_swig_exception(NSString* imarg1, void* imarg2)
{
  std::string *arg1 = 0 ;
  Foo *arg2 = 0 ;
  void* imresult = 0 ;
