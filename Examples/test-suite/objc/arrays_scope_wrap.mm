...
void _wrap_Bar_adata_set(void* imarg1, void* imarg2)
{
  foo::Bar *arg1 = 0 ;
  int *arg2 = (int *)0 ;
  ...
  {
    size_t ii;
    int *b = (int *) arg1->adata;
    for (ii = 0; ii < (size_t)ASIZE; ii++) b[ii] = *((int *) arg2 + ii);
  }
}

void* _wrap_Bar_adata_get(void* imarg1)
{
  foo::Bar *arg1 = 0 ;
  void* imresult = 0 ;
  int *result = 0 ;
  ...
  arg1 = (foo::Bar *)imarg1; 
  result = (int *)(int *) ((arg1)->adata);
  imresult = result; 
  return imresult;
}

void _wrap_Bar_bdata_set(void* imarg1, void* imarg2)
{
  foo::Bar *arg1 = 0 ;
  int *arg2 = (int *)0 ;
  ...
  {
    size_t ii;
    int *b = (int *) arg1->bdata;
    for (ii = 0; ii < (size_t)foo::BBSIZE; ii++) b[ii] = *((int *) arg2 + ii);
  }
}

void* _wrap_Bar_bdata_get(void* imarg1)
{
  foo::Bar *arg1 = 0 ;
  void* imresult = 0 ;
  int *result = 0 ;
  ...
  arg1 = (foo::Bar *)imarg1; 
  result = (int *)(int *) ((arg1)->bdata);
  imresult = result; 
  return imresult;
}

void _wrap_Bar_cdata_set(void* imarg1, void* imarg2)
{
  foo::Bar *arg1 = 0 ;
  int *arg2 = (int *)0 ;
  ...
  {
    size_t ii;
    int *b = (int *) arg1->cdata;
    for (ii = 0; ii < (size_t)foo::Bar::CCSIZE; ii++) b[ii] = *((int *) arg2 + ii);
  }
}

void* _wrap_Bar_cdata_get(void* imarg1)
{
  foo::Bar *arg1 = 0 ;
  void* imresult = 0 ;
  int *result = 0 ;
  ...
  arg1 = (foo::Bar *)imarg1; 
  result = (int *)(int *) ((arg1)->cdata);
  imresult = result; 
  return imresult;
}

void _wrap_Bar_blah(void* imarg1, void* imarg2, void* imarg3, void* imarg4)
{
  foo::Bar *arg1 = 0 ;
  int *arg2 = (int *)0 ;
  int *arg3 = (int *)0 ;
