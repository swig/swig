...
void* _wrap_new_MyError()
{
  void* imresult = 0 ;
  MyError *result = 0 ;
  
  result = (MyError *)new MyError();
...
void _wrap_delete_MyError(void* imarg1)
{
  MyError *arg1 = 0 ;
...
void* _wrap_new_SomeClass(int imarg1)
{
  int arg1 ;
  void* imresult = 0 ;
  SomeClass *result = 0 ;
  ...
  arg1 = (int)imarg1; 
  result = (SomeClass *)new SomeClass(arg1);
...
void* _wrap_new_Test(int imarg1)
{
  int arg1 ;
  void* imresult = 0 ;
  Test *result = 0 ;
