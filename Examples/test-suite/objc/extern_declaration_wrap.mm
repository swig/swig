...
int _wrap_externimport(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)externimport(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_externexport(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)externexport(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_externstdcall(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
