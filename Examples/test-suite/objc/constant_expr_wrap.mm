...
void _wrap_d_array_set(void* imarg1)
{
  ...
  {
    size_t ii;
    double *b = (double *) d_array;
    for (ii = 0; ii < (size_t)12%9; ii++) b[ii] = *((double *) arg1 + ii);
  }
}

void* _wrap_d_array_get()
{
  void* imresult = 0 ;
  double *result = 0 ;
  
  result = (double *)(double *)d_array;
  imresult = result; 
  return imresult;
}
...
{
  fakestd::array< int,(1 < 2?100:50) > *arg1 = 0 ;
  
  arg1 = (fakestd::array< int,(1 < 2?100:50) > *)imarg1; 
  bar(arg1);
}

int _wrap_WSTRING_LIT_LEN1()
{
  int imresult = 0 ;
  int result;
  
  result = (int) (sizeof(L"1234")/sizeof(wchar_t)-1);
  imresult = result; 
  return imresult;
}

int _wrap_WSTRING_LIT_LEN2()
{
  int imresult = 0 ;
  int result;
  
  result = (int) (sizeof(L"12" L"34")/sizeof(wchar_t)-1);
  imresult = result; 
  return imresult;
}

int _wrap_WSTRING_LIT_LEN3()
{
  int imresult = 0 ;
  int result;
  
  result = (int) (sizeof(L"12\
" "34")/sizeof(wchar_t)-1);
  imresult = result; 
  return imresult;
}
