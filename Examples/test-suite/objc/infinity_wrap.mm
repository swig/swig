...
double _wrap_INFINITY_get()
{
  double imresult = 0 ;
  double result;
  
  result = (double)(double)MYINFINITY;
  imresult = result; 
  return imresult;
}

void _wrap_initialise_MYINFINITY()
{
  initialise_MYINFINITY();
}

float _wrap_use_infinity(float imarg1)
{
  float arg1 ;
  float imresult = 0 ;
  float result;
  ...
  arg1 = (float)imarg1; 
  result = (float)use_infinity(arg1);
  imresult = result; 
  return imresult;
}
