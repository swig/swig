...
void* _wrap_new_ThreeException()
{
  void* imresult = 0 ;
  ThreeException *result = 0 ;
  
  result = (ThreeException *)new ThreeException();
...
void _wrap_delete_ThreeException(void* imarg1)
{
  ThreeException *arg1 = 0 ;
  
  arg1 = (ThreeException *)imarg1; 
  delete arg1;
}

void _wrap_test_catches(int imarg1)
{
  int arg1 ;
  ...
  try {
    ...
    return ; 
  } catch(ThreeException const &_e) {
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ ThreeException const & exception thrown");
    return ; 
  }
}

void _wrap_test_exception_specification(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  try {
    test_exception_specification(arg1);
  } catch(int &_e) {
    char error_msg[256];
    sprintf(error_msg, "C++ int exception thrown, value: %d", _e);
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, error_msg);
...
void _wrap_test_catches_all(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  try {
    test_catches_all(arg1);
  } catch(...) {
    SWIG_exception(SWIG_RuntimeError,"unknown exception");
  }
}
