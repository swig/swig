...
#define SWIGTYPE_p__Foo swig_types[0]
#define SWIGTYPE_p__iFoo swig_types[1]
#define SWIGTYPE_p_foo1 swig_types[2]
#define SWIGTYPE_p_foo2 swig_types[3]
...
static swig_type_info _swigt__p__iFoo = {"_p__iFoo", "iFoo *|struct _iFoo *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_foo1 = {"_p_foo1", "foo1 *|enum foo1 *", 0, 0, (void*)0, 0};
...
void _wrap_bar2(int imarg1)
{
  enum foo2 arg1 ;
  
  arg1 = (enum foo2)imarg1; 
  bar2(arg1);
}

void _wrap_bar3(int imarg1)
{
  foo3 arg1 ;
...
void _wrap_Foo_e_set(void* imarg1, int imarg2)
{
  struct _Foo *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Foo_e_get(void* imarg1)
{
  struct _Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void _wrap_iFoo_e_set(void* imarg1, int imarg2)
{
  struct _iFoo *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct _iFoo *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1 && sizeof(int) == sizeof((arg1)->e)) *(int*)(void*)&((arg1)->e) = arg2;
}

int _wrap_iFoo_e_get(void* imarg1)
{
  struct _iFoo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void _wrap_delete_iFoo(void* imarg1)
{
  struct _iFoo *arg1 = 0 ;
...
void _wrap_enumInstance_set(int imarg1)
{
  enum Exclamation arg1 ;
  
  arg1 = (enum Exclamation)imarg1; 
  enumInstance = arg1;
}

int _wrap_enumInstance_get()
{
  int imresult = 0 ;
...
void _wrap_Slap_set(int imarg1)
{
  enum ContainYourself arg1 ;
  
  arg1 = (enum ContainYourself)imarg1; 
  Slap = arg1;
}
...
void _wrap_Mine_set(int imarg1)
{
  enum ContainYourself arg1 ;
...
void _wrap_Thigh_set(int imarg1)
{
  enum ContainYourself arg1 ;
...
void _wrap_pThigh_set(void* imarg1)
{
  enum ContainYourself *arg1 = 0 ;
  
  arg1 = (enum ContainYourself *)imarg1; 
  pThigh = arg1;
}

void* _wrap_pThigh_get()
{
  void* imresult = 0 ;
...
void _wrap_arrayContainYourself_set(void* imarg1)
{
...
void* _wrap_arrayContainYourself_get()
{
  void* imresult = 0 ;
  enum ContainYourself *result = 0 ;
