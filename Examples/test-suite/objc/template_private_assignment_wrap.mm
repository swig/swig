...
void* _wrap_deleted_bits_get()
{
  void* imresult = 0 ;
  DeletedBits< int,double > *result = 0 ;
  
  result = (DeletedBits< int,double > *)&deleted_bits;
...
void* _wrap_deleted_bits2_get()
{
  void* imresult = 0 ;
  DeletedBits2< int,double > *result = 0 ;
  
  result = (DeletedBits2< int,double > *)&deleted_bits2;
...
void* _wrap_new_AssignTestType()
{
  void* imresult = 0 ;
  AssignTestType *result = 0 ;
  
  result = (AssignTestType *)new AssignTestType();
...
void _wrap_delete_AssignTestType(void* imarg1)
{
  AssignTestType *arg1 = 0 ;
  
  arg1 = (AssignTestType *)imarg1; 
  delete arg1;
}

void* _wrap_new_AssignTestTmpl()
{
  void* imresult = 0 ;
  AssignTestTemplate< AssignTestType > *result = 0 ;
  
  result = (AssignTestTemplate< AssignTestType > *)new AssignTestTemplate< AssignTestType >();
...
void* _wrap_AssignTestTmpl_assigntesttemplate_get(void* imarg1)
{
  AssignTestTemplate< AssignTestType > *arg1 = 0 ;
  void* imresult = 0 ;
  AssignTestType *result = 0 ;
  
  arg1 = (AssignTestTemplate< AssignTestType > *)imarg1; 
  result = (AssignTestType *)& ((arg1)->assigntesttemplate);
...
void _wrap_delete_AssignTestTmpl(void* imarg1)
{
  AssignTestTemplate< AssignTestType > *arg1 = 0 ;
...
void* _wrap_AssignTestContainer_assigntestcontainer_get(void* imarg1)
{
  AssignTestContainer *arg1 = 0 ;
  void* imresult = 0 ;
  AssignTestTemplate< AssignTestType > *result = 0 ;
  
  arg1 = (AssignTestContainer *)imarg1; 
  result = (AssignTestTemplate< AssignTestType > *)& ((arg1)->assigntestcontainer);
...
void* _wrap_new_AssignTestContainer()
{
  void* imresult = 0 ;
  AssignTestContainer *result = 0 ;
  
  result = (AssignTestContainer *)new AssignTestContainer();
...
void _wrap_delete_AssignTestContainer(void* imarg1)
{
  AssignTestContainer *arg1 = 0 ;
