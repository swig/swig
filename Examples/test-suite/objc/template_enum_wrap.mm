...
#define SWIGTYPE_p_ComponentType swig_types[0]
...
static swig_type_info _swigt__p_ComponentType = {"_p_ComponentType", "ComponentType *", 0, 0, (void*)0, 0};
...
void _wrap_delete_foo_i(void* imarg1)
{
  foo< int > *arg1 = 0 ;
...
void _wrap_delete_foo_d(void* imarg1)
{
  foo< double > *arg1 = 0 ;
...
void* _wrap_new_RGBTraits()
{
  void* imresult = 0 ;
  Manta::RGBTraits *result = 0 ;
  
  result = (Manta::RGBTraits *)new Manta::RGBTraits();
...
void _wrap_delete_RGBTraits(void* imarg1)
{
  Manta::RGBTraits *arg1 = 0 ;
  
  arg1 = (Manta::RGBTraits *)imarg1; 
  delete arg1;
}

void _wrap_Color_data_set(void* imarg1, void* imarg2)
{
  Manta::ColorSpace< Manta::RGBTraits > *arg1 = 0 ;
  Manta::ColorSpace< Manta::RGBTraits >::ComponentType *arg2 = (Manta::ColorSpace< Manta::RGBTraits >::ComponentType *)0 ;
  
  arg1 = (Manta::ColorSpace< Manta::RGBTraits > *)imarg1; 
  arg2 = (Manta::ColorSpace< Manta::RGBTraits >::ComponentType *)imarg2; 
  {
    size_t ii;
    Manta::ColorSpace< Manta::RGBTraits >::ComponentType *b = (Manta::ColorSpace< Manta::RGBTraits >::ComponentType *) arg1->data;
    for (ii = 0; ii < (size_t)Manta::ColorSpace< Manta::RGBTraits >::NumComponents; ii++) b[ii] = *((Manta::ColorSpace< Manta::RGBTraits >::ComponentType *) arg2 + ii);
  }
}

void* _wrap_Color_data_get(void* imarg1)
{
  Manta::ColorSpace< Manta::RGBTraits > *arg1 = 0 ;
  void* imresult = 0 ;
  Manta::ColorSpace< Manta::RGBTraits >::ComponentType *result = 0 ;
  
  arg1 = (Manta::ColorSpace< Manta::RGBTraits > *)imarg1; 
  result = (Manta::ColorSpace< Manta::RGBTraits >::ComponentType *)(Manta::ColorSpace< Manta::RGBTraits >::ComponentType *) ((arg1)->data);
  imresult = result; 
  return imresult;
}

void* _wrap_new_Color()
{
  void* imresult = 0 ;
  Manta::ColorSpace< Manta::RGBTraits > *result = 0 ;
  
  result = (Manta::ColorSpace< Manta::RGBTraits > *)new Manta::ColorSpace< Manta::RGBTraits >();
...
void _wrap_delete_Color(void* imarg1)
{
  Manta::ColorSpace< Manta::RGBTraits > *arg1 = 0 ;
