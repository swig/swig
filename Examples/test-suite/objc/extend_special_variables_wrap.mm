...
SWIGINTERN ForExtension *new_ForExtension(){
    return new ForExtension();
  }
SWIGINTERN char const *ForExtension_extended__SWIG_0(ForExtension *self){
    return "name:extended symname:extended_renamed wrapname: overname:__SWIG_0 decl:ForExtension::extended() fulldecl:char const * ForExtension::extended() parentclasssymname:ForExtensionNewName parentclassname:ForExtension";
  }
...
SWIGINTERN void Space_ExtendTemplate_Sl_int_Sg__extending(Space::ExtendTemplate< int > *self){
   Space::ExtendTemplate< int > tmp;
   (void)tmp;
  }
...
void* _wrap_new_ForExtensionNewName()
{
  void* imresult = 0 ;
  ForExtension *result = 0 ;
  
  result = (ForExtension *)new_ForExtension();
...
NSString * _wrap_ForExtensionNewName_extended_renamed(void* imarg1)
{
  ForExtension *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
  
  arg1 = (ForExtension *)imarg1; 
  result = (char *)ForExtension_extended__SWIG_0(arg1);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}

void _wrap_delete_ForExtensionNewName(void* imarg1)
{
  ForExtension *arg1 = 0 ;
...
void _wrap_ExtendTemplateInt_extending(void* imarg1)
{
  Space::ExtendTemplate< int > *arg1 = 0 ;
  
  arg1 = (Space::ExtendTemplate< int > *)imarg1; 
  Space_ExtendTemplate_Sl_int_Sg__extending(arg1);
}

void* _wrap_new_ExtendTemplateInt()
{
  void* imresult = 0 ;
  Space::ExtendTemplate< int > *result = 0 ;
  
  result = (Space::ExtendTemplate< int > *)new Space::ExtendTemplate< int >();
...
void _wrap_delete_ExtendTemplateInt(void* imarg1)
{
  Space::ExtendTemplate< int > *arg1 = 0 ;
