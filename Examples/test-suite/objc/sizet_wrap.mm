...
unsigned long _wrap_test1(unsigned long imarg1)
{
  size_t arg1 ;
  ...
  arg1 = (size_t)imarg1; 
  result = test1(SWIG_STD_MOVE(*(&arg1)));
  imresult = result; 
  return imresult;
}

unsigned long _wrap_test2(unsigned long imarg1)
{
  std::size_t arg1 ;
  unsigned long imresult = 0 ;
  std::size_t result;
  
  arg1 = (std::size_t)imarg1; 
  result = test2(SWIG_STD_MOVE(*(&arg1)));
  imresult = result; 
  return imresult;
}

unsigned long  * _wrap_test3(unsigned long  * imarg1)
{
  std::size_t *arg1 = 0 ;
  unsigned long  * imresult = 0 ;
  std::size_t *result = 0 ;
  ...
  arg1 = (std::size_t *)imarg1; 
  result = (std::size_t *) &test3((std::size_t const &)*arg1);
...
unsigned long  * _wrap_test4(unsigned long  * imarg1)
{
  size_t *arg1 = 0 ;
  unsigned long  * imresult = 0 ;
  size_t *result = 0 ;
  ...
  arg1 = (size_t *)imarg1; 
  result = (size_t *) &test4((size_t const &)*arg1);
