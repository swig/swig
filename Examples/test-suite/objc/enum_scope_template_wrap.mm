...
int _wrap_chop(int imarg1)
{
  enum Tree< int >::types arg1 ;
  int imresult = 0 ;
  enum Tree< int >::types result;
  
  arg1 = (enum Tree< int >::types)imarg1; 
  result = (enum Tree< int >::types)chop(arg1);
  imresult = (int)result; 
  return imresult;
}

void _wrap_TreeInt_chop(void* imarg1, int imarg2)
{
  Tree< int > *arg1 = 0 ;
  enum Tree< int >::types arg2 ;
  
  arg1 = (Tree< int > *)imarg1; 
  arg2 = (enum Tree< int >::types)imarg2; 
  (arg1)->chop(arg2);
}

void* _wrap_new_TreeInt()
{
  void* imresult = 0 ;
  Tree< int > *result = 0 ;
  
  result = (Tree< int > *)new Tree< int >();
...
void _wrap_delete_TreeInt(void* imarg1)
{
  Tree< int > *arg1 = 0 ;
