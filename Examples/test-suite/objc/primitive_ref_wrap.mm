...
const int &ref_int(const int &x) {
   static int y = x;
   return y;
}


const unsigned int &ref_uint(const unsigned int &x) {
   static unsigned int y = x;
   return y;
}


const short &ref_short(const short &x) {
   static short y = x;
   return y;
}


const unsigned short &ref_ushort(const unsigned short &x) {
   static unsigned short y = x;
   return y;
}


const long &ref_long(const long &x) {
   static long y = x;
   return y;
}


const unsigned long &ref_ulong(const unsigned long &x) {
   static unsigned long y = x;
   return y;
}


const signed char &ref_schar(const signed char &x) {
   static signed char y = x;
   return y;
}


const unsigned char &ref_uchar(const unsigned char &x) {
   static unsigned char y = x;
   return y;
}


const char &ref_char(const char &x) {
   static char y = x;
   return y;
}


const float &ref_float(const float &x) {
   static float y = x;
   return y;
}


const double &ref_double(const double &x) {
   static double y = x;
   return y;
}


const bool &ref_bool(const bool &x) {
   static bool y = x;
   return y;
}


const long long &ref_longlong(const long long &x) {
   static long long y = x;
   return y;
}


const unsigned long long &ref_ulonglong(const unsigned long long &x) {
   static unsigned long long y = x;
   return y;
}
...
unsigned int * _wrap_ref_uint(unsigned int * imarg1)
{
  unsigned int *arg1 = 0 ;
...
short * _wrap_ref_short(short * imarg1)
{
  short *arg1 = 0 ;
  short * imresult = 0 ;
  short *result = 0 ;
...
unsigned short * _wrap_ref_ushort(unsigned short * imarg1)
{
...
long * _wrap_ref_long(long * imarg1)
{
  long *arg1 = 0 ;
  long * imresult = 0 ;
  long *result = 0 ;
...
unsigned long  * _wrap_ref_ulong(unsigned long  * imarg1)
{
...
signed char * _wrap_ref_schar(signed char * imarg1)
{
  signed char *arg1 = 0 ;
...
unsigned char * _wrap_ref_uchar(unsigned char * imarg1)
{
...
char * _wrap_ref_char(char * imarg1)
{
  char *arg1 = 0 ;
  char * imresult = 0 ;
  char *result = 0 ;
...
float * _wrap_ref_float(float * imarg1)
{
  float *arg1 = 0 ;
  float * imresult = 0 ;
  float *result = 0 ;
  ...
  arg1 = (float *)imarg1; 
  result = (float *) &ref_float((float const &)*arg1);
...
double * _wrap_ref_double(double * imarg1)
{
  double *arg1 = 0 ;
  double * imresult = 0 ;
  double *result = 0 ;
  ...
  arg1 = (double *)imarg1; 
  result = (double *) &ref_double((double const &)*arg1);
...
BOOL * _wrap_ref_bool(BOOL * imarg1)
{
  bool temp1 ;
  bool *arg1 = 0 ;
  BOOL * imresult = 0 ;
...
long long * _wrap_ref_longlong(long long * imarg1)
{
  long long *arg1 = 0 ;
  ...
  result = (long long *) &ref_longlong((long long const &)*arg1);
...
unsigned long long  * _wrap_ref_ulonglong(unsigned long long  * imarg1)
{
  ...
  result = (unsigned long long *) &ref_ulonglong((unsigned long long const &)*arg1);
...
int _wrap_ref_over(int imarg1)
{
  ...
  arg1 = (int)imarg1; 
  result = (int)ref_over(arg1);
  imresult = result; 
  return imresult;
}

void _wrap_A_v_set(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
