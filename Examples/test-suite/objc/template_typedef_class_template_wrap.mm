...
#define SWIGTYPE_p_key_type swig_types[0]
#define SWIGTYPE_p_mapped_type swig_types[1]
...
void* _wrap_MultimapA_equal_range_1(void* imarg1, int * imarg2)
{
  Standard::Multimap< int,A * > *arg1 = 0 ;
  Standard::Multimap< int,A * >::key_type *arg2 = 0 ;
  void* imresult = 0 ;
  Standard::Pair< Standard::Multimap< int,A * >::iterator,Standard::Multimap< int,A * >::iterator > *temp ;
  SwigValueWrapper< Standard::Pair< Standard::Multimap< int,A * >::iterator,Standard::Multimap< int,A * >::iterator > > result;
  
  arg1 = (Standard::Multimap< int,A * > *)imarg1; 
  arg2 = (Standard::Multimap< int,A * >::key_type *)imarg2; 
  result = (arg1)->equal_range_1((Standard::Multimap< int,A * >::key_type const &)*arg2);
  
  temp = new Standard::Pair< Standard::Multimap< int,A * >::iterator,Standard::Multimap< int,A * >::iterator >((const Standard::Pair< Standard::Multimap< int,A * >::iterator,Standard::Multimap< int,A * >::iterator > &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_MultimapA_equal_range_2(void* imarg1, int * imarg2)
{
  Standard::Multimap< int,A * > *arg1 = 0 ;
  Standard::Multimap< int,A * >::key_type *arg2 = 0 ;
  void* imresult = 0 ;
  Standard::Pair< Standard::Multimap< int,A * >::const_iterator,Standard::Multimap< int,A * >::const_iterator > *temp ;
  SwigValueWrapper< Standard::Pair< Standard::Multimap< int,A * >::const_iterator,Standard::Multimap< int,A * >::const_iterator > > result;
  
  arg1 = (Standard::Multimap< int,A * > *)imarg1; 
  arg2 = (Standard::Multimap< int,A * >::key_type *)imarg2; 
  result = ((Standard::Multimap< int,A * > const *)arg1)->equal_range_2((Standard::Multimap< int,A * >::key_type const &)*arg2);
  
  temp = new Standard::Pair< Standard::Multimap< int,A * >::const_iterator,Standard::Multimap< int,A * >::const_iterator >((const Standard::Pair< Standard::Multimap< int,A * >::const_iterator,Standard::Multimap< int,A * >::const_iterator > &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_new_MultimapA()
{
  void* imresult = 0 ;
...
void _wrap_delete_MultimapA(void* imarg1)
{
  Standard::Multimap< int,A * > *arg1 = 0 ;
