...
static swig_cast_info _swigc__p_XXX[] = {  {&_swigt__p_XXX, 0, 0, 0},  {&_swigt__p_YYY, _p_YYYTo_p_XXX, 0, 0},{0, 0, 0, 0}};
...
int _wrap_XXX_testx(void* imarg1)
{
  XXX *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_YYY_testy(void* imarg1)
{
  YYY *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* SWIG_ObjectiveC_cast__p_YYY_to__p_XXX(void* imarg1) {
#ifdef __cplusplus
  return (void*)((XXX *)((YYY *)imarg1));
#else
  return imarg1;
#endif
}
void _wrap_use_www_b(void* imarg1)
{
  WWW *arg1 = 0 ;
  
  arg1 = (WWW *)imarg1; 
  use_www_b((WWW const &)*arg1);
}
