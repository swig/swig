...
{
  int imresult = 0 ;
  enum ForwardEnum1 result;
  
  result = (enum ForwardEnum1)get_enum1();
  imresult = (int)result; 
  return imresult;
}

int _wrap_test_function1(int imarg1)
{
  enum ForwardEnum1 arg1 ;
  int imresult = 0 ;
  enum ForwardEnum1 result;
  
  arg1 = (enum ForwardEnum1)imarg1; 
  result = (enum ForwardEnum1)test_function1(arg1);
  imresult = (int)result; 
  return imresult;
}
...
{
  int imresult = 0 ;
  enum ForwardEnum2 result;
  
  result = (enum ForwardEnum2)get_enum2();
  imresult = (int)result; 
  return imresult;
}

int _wrap_test_function2(int imarg1)
{
  enum ForwardEnum2 arg1 ;
  int imresult = 0 ;
  enum ForwardEnum2 result;
  
  arg1 = (enum ForwardEnum2)imarg1; 
  result = (enum ForwardEnum2)test_function2(arg1);
  imresult = (int)result; 
  return imresult;
}
...
{
  int imresult = 0 ;
  enum ForwardEnum3 result;
  
  result = (enum ForwardEnum3)get_enum3();
  imresult = (int)result; 
  return imresult;
}

int _wrap_test_function3(int imarg1)
{
  enum ForwardEnum3 arg1 ;
  int imresult = 0 ;
  enum ForwardEnum3 result;
  
  arg1 = (enum ForwardEnum3)imarg1; 
  result = (enum ForwardEnum3)test_function3(arg1);
  imresult = (int)result; 
  return imresult;
}
