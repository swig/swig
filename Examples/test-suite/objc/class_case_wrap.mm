...
#define SWIGTYPE_p_classB swig_types[0]
#define SWIGTYPE_p_classB2 swig_types[1]
...
static void *_p_classB2To_p_classB(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((classB *)  ((classB2 *) x));
}
static swig_type_info _swigt__p_classB = {"_p_classB", "classB *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_classB2 = {"_p_classB2", 0, 0, 0, 0, 0};
...
static swig_cast_info _swigc__p_classB2[] = {{&_swigt__p_classB2, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_classB[] = {  {&_swigt__p_classB, 0, 0, 0},  {&_swigt__p_classB2, _p_classB2To_p_classB, 0, 0},{0, 0, 0, 0}};
...
void* _wrap_new_classB()
{
  void* imresult = 0 ;
  classB *result = 0 ;
  
  result = (classB *)new classB();
...
void _wrap_delete_classB(void* imarg1)
{
  classB *arg1 = 0 ;
...
void* _wrap_new_classB2()
{
  void* imresult = 0 ;
  classB2 *result = 0 ;
  
  result = (classB2 *)new classB2();
...
void _wrap_delete_classB2(void* imarg1)
{
  classB2 *arg1 = 0 ;
...
void* SWIG_ObjectiveC_cast__p_classB2_to__p_classB(void* imarg1) {
#ifdef __cplusplus
  return (void*)((classB *)((classB2 *)imarg1));
#else
  return imarg1;
#endif
}
int _wrap_Test1(void* imarg1)
{
  ClassA *arg1 = 0 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (ClassA *)imarg1; 
  result = (int)Test1(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_Test2(void* imarg1)
{
  classB *arg1 = 0 ;
  int imresult = 0 ;
  int result;
