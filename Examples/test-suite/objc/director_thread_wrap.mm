...
public:
  ...
  bool swig_override_do_foo__ffF_;
  virtual void do_foo();
};
...
void SwigDirector_Foo::do_foo() {
  if (!swig_objc_self || !swig_override_do_foo__ffF_) {
    Foo::do_foo();
    return;
  }
  typedef void (*SWIG_ObjCMsgSend_swig_override_do_foo__ffF__t)(SWIGObjectiveCId, SEL);
  ((SWIG_ObjCMsgSend_swig_override_do_foo__ffF__t)objc_msgSend)(swig_objc_self, @selector(do_foo));
  return;
}
...
void SwigDirector_Foo::swig_connect_director(SWIGObjectiveCId obj) {
  ...
  swig_override_do_foo__ffF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(do_foo));
}
