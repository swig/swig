...
#include "template_empty_inherit_wrap.h"
...
int _wrap_SquareFunctor_FunctorOperator(void* imarg1, int imarg2)
{
  SquareFunctor *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
  int result;
  
  arg1 = (SquareFunctor *)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)((SquareFunctor const *)arg1)->operator ()(arg2);
  imresult = result; 
  return imresult;
}

void* _wrap_new_SquareFunctor()
{
  void* imresult = 0 ;
  SquareFunctor *result = 0 ;
  
  result = (SquareFunctor *)new SquareFunctor();
...
void _wrap_delete_SquareFunctor(void* imarg1)
{
  SquareFunctor *arg1 = 0 ;
...
void* _wrap_squares(void* imarg1)
{
  std::vector< int > *arg1 = 0 ;
  void* imresult = 0 ;
  std::vector< int > *temp ;
  ...
  arg1 = (std::vector< int > *)imarg1; 
  result = squares((std::vector< int > const &)*arg1);
