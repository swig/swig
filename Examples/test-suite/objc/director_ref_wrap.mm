...
public:
  ...
  SwigDirector_Foo();
  bool swig_override_OnDelete__ffF_;
  virtual void OnDelete();
...
void SwigDirector_Foo::OnDelete() {
  if (!swig_objc_self || !swig_override_OnDelete__ffF_) {
    Foo::OnDelete();
    return;
  }
  typedef void (*SWIG_ObjCMsgSend_swig_override_OnDelete__ffF__t)(SWIGObjectiveCId, SEL);
  ((SWIG_ObjCMsgSend_swig_override_OnDelete__ffF__t)objc_msgSend)(swig_objc_self, @selector(OnDelete));
  return;
}
...
void SwigDirector_Foo::swig_connect_director(SWIGObjectiveCId obj) {
  ...
  swig_override_OnDelete__ffF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(OnDelete));
...
int _wrap_FooPtr_GetOwnedRefCount(void* imarg1)
{
  ...
  arg1 = (FooPtr *)imarg1; 
  result = (int)(arg1)->GetOwnedRefCount();
  imresult = result; 
  return imresult;
}
