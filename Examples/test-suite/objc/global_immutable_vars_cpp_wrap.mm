...
#include "global_immutable_vars_cpp_wrap.h"
...
void _wrap_default_mutable_var_set(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  default_mutable_var = arg1;
}

int _wrap_default_mutable_var_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)default_mutable_var;
  imresult = result; 
  return imresult;
}

int _wrap_global_immutable_var_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)global_immutable_var;
  imresult = result; 
  return imresult;
}

void _wrap_specific_mutable_var_set(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  specific_mutable_var = arg1;
}

int _wrap_specific_mutable_var_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)specific_mutable_var;
  imresult = result; 
  return imresult;
}

void _wrap_global_mutable_var_set(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  global_mutable_var = arg1;
}

int _wrap_global_mutable_var_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)global_mutable_var;
  imresult = result; 
  return imresult;
}

int _wrap_specific_immutable_var_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)specific_immutable_var;
  imresult = result; 
  return imresult;
}

int _wrap_check_values(int imarg1, int imarg2, int imarg3, int imarg4, int imarg5)
{
  int arg1 ;
  int arg2 ;
  int arg3 ;
  ...
  arg4 = (int)imarg4; 
  arg5 = (int)imarg5; 
  result = (int)check_values(arg1,arg2,arg3,arg4,arg5);
  imresult = result; 
  return imresult;
}
