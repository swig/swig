...
double _wrap_Foo_blah(void* imarg1)
{
  Foo *arg1 = 0 ;
  double imresult = 0 ;
  Foo::Number result;
...
int _wrap_Bar_blah(void* imarg1)
{
  Bar *arg1 = 0 ;
  int imresult = 0 ;
  Bar::Number result;
...
int _wrap_spam()
{
  ...
  result = (Bar::Number)spam();
  imresult = result; 
  return imresult;
}

double _wrap_twoFoo(void* imarg1)
{
  Foo *arg1 = 0 ;
  double imresult = 0 ;
  Foo::Number result;
  ...
  arg1 = (Foo *)imarg1; 
  result = (Foo::Number)twoblah< Foo >(*arg1);
  imresult = result; 
  return imresult;
}

int _wrap_twoBar(void* imarg1)
{
  Bar *arg1 = 0 ;
  int imresult = 0 ;
  Bar::Number result;
  ...
  arg1 = (Bar *)imarg1; 
  result = (Bar::Number)twoblah< Bar >(*arg1);
  imresult = result; 
  return imresult;
}
