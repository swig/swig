...
void _wrap_foo(void* imarg1)
{
  ...
  argp10 = (vector< int > *)imarg1;
  arg1 = *argp10;
  
  foo(SWIG_STD_MOVE(*(&arg1)));
}

void _wrap_bar(void* imarg1)
{
  vector< unsigned int > *argp1 ;
  vector< unsigned int > arg1 ;
  vector< unsigned int > *argp10 ;
  
  
  argp10 = (vector< unsigned int > *)imarg1;
  arg1 = *argp10;
  
  bar(SWIG_STD_MOVE(*(&arg1)));
}

void _wrap_baz(void* imarg1)
{
  map< int,int > *argp1 ;
  map< int,int > arg1 ;
  map< int,int > *argp10 ;
  ...
  argp10 = (map< int,int > *)imarg1;
  arg1 = *argp10;
  
  baz(SWIG_STD_MOVE(*(&arg1)));
}
