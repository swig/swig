...
public:
  ...
  bool swig_override_description__ffF_;
...
std::string SwigDirector_BaseClass::description() const {
  std::string c_result = SwigValueInit< std::string >() ;
  NSString * objc_result ;
  
  if (!swig_objc_self || !swig_override_description__ffF_) {
    SWIG_ObjcThrowException(SWIG_ObjcDirectorPureVirtual, "Attempted to invoke pure virtual method BaseClass::description");
    return c_result;
  }
  typedef NSString * (*SWIG_ObjCMsgSend_swig_override_description__ffF__t)(SWIGObjectiveCId, SEL);
  objc_result = ((SWIG_ObjCMsgSend_swig_override_description__ffF__t)objc_msgSend)(swig_objc_self, @selector(description));
...
void SwigDirector_BaseClass::swig_connect_director(SWIGObjectiveCId obj) {
  ...
  swig_override_description__ffF_ = SWIG_ObjectiveC_HasOverride(actual_class, base_class, @selector(description));
}
...
NSString* _wrap_BaseClass_description(void* imarg1)
{
  ...
  if (upcall) {
    Swig::DirectorPureVirtualException::raise("BaseClass::description");
  } else {
    result = ((BaseClass const *)arg1)->description();
  }
...
NSString* _wrap_BaseClass_call_description(void* imarg1)
{
  ...
  arg1 = (BaseClass *)imarg1; 
  try {
    result = BaseClass::call_description(*arg1);
  } catch(Swig::DirectorException &_e) {
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Swig::DirectorException exception thrown");
    return 0; 
  }
  imresult = [NSString stringWithUTF8String: (&result)->c_str()]; 
  return imresult;
