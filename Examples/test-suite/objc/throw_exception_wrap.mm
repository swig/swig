...
#define SWIGTYPE_p_CError swig_types[0]
#define SWIGTYPE_p_a_10__int swig_types[1]
...
static swig_type_info _swigt__p_CError = {"_p_CError", "Namespace::ErrorTypedef *|CError *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_a_10__int = {"_p_a_10__int", "Namespace::IntArray *|int (*)[10]", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_CError[] = {  {&_swigt__p_CError, 0, 0, 0},{0, 0, 0, 0}};
...
void* _wrap_new_CError()
{
  void* imresult = 0 ;
  CError *result = 0 ;
  
  result = (CError *)new CError();
...
void _wrap_delete_CError(void* imarg1)
{
  CError *arg1 = 0 ;
...
void _wrap_test_is_Error(void* imarg1)
{
  CError *arg1 = 0 ;
...
void _wrap_Foo_test_int(void* imarg1)
{
  Foo *arg1 = 0 ;
...
void _wrap_Foo_test_msg(void* imarg1)
{
  Foo *arg1 = 0 ;
...
void _wrap_Foo_test_cls(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ CError exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_cls_ptr(void* imarg1)
{
  Foo *arg1 = 0 ;
...
void _wrap_Foo_test_cls_ref(void* imarg1)
{
  Foo *arg1 = 0 ;
...
void _wrap_Foo_test_cls_td(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Namespace::ErrorTypedef exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_cls_ptr_td(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Namespace::ErrorPtr exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_cls_ref_td(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Namespace::ErrorRef exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_array(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ int [10] exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_enum(void* imarg1)
{
  Foo *arg1 = 0 ;
  ...
  try {
    ...
    (void)_e;
    SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ Namespace::EnumTest exception thrown");
    return ; 
  }
}

void _wrap_Foo_test_multi(void* imarg1, int imarg2)
{
  Foo *arg1 = 0 ;
  int arg2 ;
