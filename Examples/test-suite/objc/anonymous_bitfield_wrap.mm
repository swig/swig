...
void _wrap_Foo_f_set(void* imarg1, unsigned int imarg2)
{
  Foo *arg1 = 0 ;
  unsigned int arg2 ;
...
unsigned int _wrap_Foo_f_get(void* imarg1)
{
  Foo *arg1 = 0 ;
...
void _wrap_Foo_z_set(void* imarg1, int imarg2)
{
  Foo *arg1 = 0 ;
  int arg2 ;
...
int _wrap_Foo_z_get(void* imarg1)
{
  Foo *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void _wrap_Foo_seq_set(void* imarg1, unsigned int imarg2)
{
  Foo *arg1 = 0 ;
  unsigned int arg2 ;
...
unsigned int _wrap_Foo_seq_get(void* imarg1)
{
  Foo *arg1 = 0 ;
  unsigned int imresult = 0 ;
  unsigned int result;
