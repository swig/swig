...
void* _wrap_MyHandle_Foo2___deref__(void* imarg1)
{
  MyHandle_Foo2 *arg1 = 0 ;
  void* imresult = 0 ;
  Foo2 *result = 0 ;
  
  arg1 = (MyHandle_Foo2 *)imarg1; 
  result = (Foo2 *)(arg1)->operator ->();
...
void* _wrap_new_MyHandle_Foo2()
{
  void* imresult = 0 ;
  MyHandle_Foo2 *result = 0 ;
  
  result = (MyHandle_Foo2 *)new MyHandle_Foo2();
...
void _wrap_delete_MyHandle_Foo2(void* imarg1)
{
  MyHandle_Foo2 *arg1 = 0 ;
...
int _wrap_MyHandle_Foo2_sum(void* imarg1, int imarg2, int imarg3)
{
  MyHandle_Foo2 *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
...
int _wrap_Foo2_sum(void* imarg1, int imarg2, int imarg3)
{
  Foo2 *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
