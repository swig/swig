...
#include "template_arg_replace_wrap.h"
...
void _wrap_matrix33f_Func(void* imarg1, void* imarg2)
{
  test_Matrix< float,3,3 > *arg1 = 0 ;
  test_Matrix< float,3,3 > *arg2 = 0 ;
  
  arg1 = (test_Matrix< float,3,3 > *)imarg1; 
  arg2 = (test_Matrix< float,3,3 > *)imarg2; 
  (arg1)->Func((test_Matrix< float,3,3 > const &)*arg2);
}

void* _wrap_new_matrix33f()
{
  void* imresult = 0 ;
  test_Matrix< float,3,3 > *result = 0 ;
  
  result = (test_Matrix< float,3,3 > *)new test_Matrix< float,3,3 >();
...
void _wrap_delete_matrix33f(void* imarg1)
{
  test_Matrix< float,3,3 > *arg1 = 0 ;
