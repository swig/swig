...
void* _wrap_Bar_blah(void* imarg1)
{
  Bar *arg1 = 0 ;
  void* imresult = 0 ;
  Foo *result = 0 ;
...
NSString * _wrap_Bar_test(void* imarg1)
{
  Bar *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
...
NSString * _wrap_do_test(void* imarg1)
{
  Bar *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
  ...
  arg1 = (Bar *)imarg1; 
  result = (char *)do_test(arg1);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}

static void SWIG_ObjectiveC_dynamic_cast_Init(void) {
  SWIGTYPE_p_Foo->dcast = (swig_dycast_func) Foo_dynamic;
  
}
#if defined(__GNUC__)
__attribute__((constructor))
#endif
static void SWIG_ObjectiveC_dynamic_cast_AutoInit(void) {
  SWIG_ObjectiveC_dynamic_cast_Init();
}
