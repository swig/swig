...
NSString * _wrap_test1(void* imarg1)
{
  Foo::Str1 *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
      ...
      if (imarg1) {
        ...
        if (utf8) {
          ...
          if (buffer) {
            ...
            arg1 = (Foo::Str1 *)buffer;
          }
        }
      }
    }
  }
  result = (char *)Foo::test1(arg1);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}

NSString * _wrap_test2(NSString * imarg1)
{
  Foo::Str2 *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
  ...
  {
    {
      ...
      if (imarg1) {
        ...
        if (utf8) {
          ...
          if (buffer) {
            memcpy(buffer, utf8, length + 1);
            arg1 = (Foo::Str2 *)buffer;
          }
        }
      }
    }
  }
  result = (char *)Foo::test2(arg1);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}
