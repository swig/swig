...
int _wrap_convolve1Bool()
{
  int imresult = 0 ;
  int result;
  
  result = (int)convolve1< bool >();
  imresult = result; 
  return imresult;
}

int _wrap_convolve2Float()
{
  int imresult = 0 ;
  int result;
  
  result = (int)convolve2< float >();
  imresult = result; 
  return imresult;
}

void _wrap_convolve3FloatRenamed(float imarg1)
{
  float arg1 ;
  
  arg1 = (float)imarg1; 
  convolve3< float >(arg1);
}

int _wrap_convolve4Float()
{
  int imresult = 0 ;
  int result;
  
  result = (int)convolve4< float >();
  imresult = result; 
  return imresult;
}

void _wrap_convolve4FloatRenamed(float imarg1)
{
  float arg1 ;
  
  arg1 = (float)imarg1; 
  convolve4< float >(arg1);
}

int _wrap_convolve5FloatRenamed()
{
  int imresult = 0 ;
  int result;
  
  result = (int)convolve5< float >();
  imresult = result; 
  return imresult;
}

BOOL _wrap_Klass_KlassTMethodBoolRenamed(void* imarg1, BOOL imarg2)
{
  Klass *arg1 = 0 ;
  bool arg2 ;
  BOOL imresult = 0 ;
  ...
  result = (bool)(arg1)->SWIGTEMPLATEDISAMBIGUATOR tmethod< bool >(arg2);
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_Klass_KlassTMethodBool(void* imarg1)
{
  Klass *arg1 = 0 ;
  
  arg1 = (Klass *)imarg1; 
  (arg1)->SWIGTEMPLATEDISAMBIGUATOR tmethod< bool >();
}

BOOL _wrap_Klass_KlassStaticTMethodBoolRenamed(BOOL imarg1)
{
  bool arg1 ;
  BOOL imresult = 0 ;
  bool result;
  ...
  result = (bool)Klass::SWIGTEMPLATEDISAMBIGUATOR statictmethod< bool >(arg1);
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_Klass_KlassStaticTMethodBool()
{
  Klass::SWIGTEMPLATEDISAMBIGUATOR statictmethod< bool >();
}
...
BOOL _wrap_Clay_ClayBoolRenamed_cmethod(void* imarg1, BOOL imarg2)
{
  Clay *arg1 = 0 ;
  bool arg2 ;
  BOOL imresult = 0 ;
  ...
  arg1 = (Clay *)imarg1; 
  arg2 = imarg2? true : false; 
  result = (bool)(arg1)->SWIGTEMPLATEDISAMBIGUATOR cmethod< bool >(arg2);
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_Clay_ClayCMethodBool(void* imarg1)
{
  Clay *arg1 = 0 ;
  
  arg1 = (Clay *)imarg1; 
  (arg1)->SWIGTEMPLATEDISAMBIGUATOR cmethod< bool >();
}

BOOL _wrap_Clay_ClayBoolStaticRenamed_staticcmethod(BOOL imarg1)
{
  bool arg1 ;
  BOOL imresult = 0 ;
  bool result;
  ...
  arg1 = imarg1? true : false; 
  result = (bool)Clay::SWIGTEMPLATEDISAMBIGUATOR staticcmethod< bool >(arg1);
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_Clay_ClayStaticCMethodBool()
{
  Clay::SWIGTEMPLATEDISAMBIGUATOR staticcmethod< bool >();
}

int _wrap_Clay_ClayIntRenamed_cmethod(void* imarg1, int imarg2)
{
  Clay *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
  ...
  arg1 = (Clay *)imarg1; 
  arg2 = (int)imarg2; 
  result = (int)(arg1)->SWIGTEMPLATEDISAMBIGUATOR cmethod< int >(arg2);
  imresult = result; 
  return imresult;
}

int _wrap_Clay_ClayIntStaticRenamed_staticcmethod(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (int)imarg1; 
  result = (int)Clay::SWIGTEMPLATEDISAMBIGUATOR staticcmethod< int >(arg1);
  imresult = result; 
  return imresult;
}
...
void _wrap_delete_Clay(void* imarg1)
{
  Clay *arg1 = 0 ;
...
void* _wrap_new_ComponentProperties()
{
  void* imresult = 0 ;
  ComponentProperties *result = 0 ;
  
  result = (ComponentProperties *)new ComponentProperties();
...
void _wrap_delete_ComponentProperties(void* imarg1)
{
  ComponentProperties *arg1 = 0 ;
  
  arg1 = (ComponentProperties *)imarg1; 
  delete arg1;
}

void _wrap_ComponentProperties_adda(void* imarg1, NSString* imarg2, NSString* imarg3, NSString* imarg4, double imarg5)
{
  ComponentProperties *arg1 = 0 ;
  std::string arg2 ;
  std::string arg3 ;
  ...
  } 
  {
    ...
    int length = [imarg4 length];
    int bufferSize = sizeof(char) * (length + 1);
    char *buffer = (char*)malloc(bufferSize);
    memset(buffer, 0, bufferSize);
    int i = 0;
    for (; i < length; ++i)
    buffer[i] = [imarg4 characterAtIndex: i];
    
    const char *arg4_pstr = (const char *)buffer;
    (&arg4)->assign(arg4_pstr);
    free(buffer);
  } 
  arg5 = (double)imarg5; 
  (arg1)->SWIGTEMPLATEDISAMBIGUATOR adda< std::string,double >(SWIG_STD_MOVE(*(&arg2)),SWIG_STD_MOVE(*(&arg3)),SWIG_STD_MOVE(*(&arg4)),arg5);
}
