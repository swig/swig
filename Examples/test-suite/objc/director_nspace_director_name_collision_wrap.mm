...
SwigDirector_Foo::SwigDirector_Foo() : TopLevel::A::Foo() {
...
#ifdef __cplusplus
  SwigDirector_Foo *director = dynamic_cast<SwigDirector_Foo *>((TopLevel::A::Foo *)imarg1);
  if (director)
...
{
  TopLevel::A::Foo *arg1 = 0 ;
  
  arg1 = (TopLevel::A::Foo *)imarg1; 
  delete arg1;
}
...
NSString* _wrap_Foo_ping(void* imarg1)
{
  ...
  arg1 = (TopLevel::A::Foo *)imarg1; 
  if (upcall) {
    result = (arg1)->TopLevel::A::Foo::ping();
  } else {
    result = (arg1)->ping();
  }
...
{
  void* imresult = 0 ;
  TopLevel::A::Foo *result = 0 ;
  
  result = (TopLevel::A::Foo *)new SwigDirector_Foo();
