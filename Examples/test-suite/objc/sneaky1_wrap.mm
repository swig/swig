...
static swig_type_info _swigt__p_f_int_int__int = {"_p_f_int_int__int", "binop *|int (*)(int,int)", 0, 0, (void*)0, 0};
...
int _wrap_mul(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
  int imresult = 0 ;
...
int _wrap_divide(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
  int imresult = 0 ;
