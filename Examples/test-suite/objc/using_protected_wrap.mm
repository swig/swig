...
#define SWIGTYPE_p_FooBar swig_types[1]
#define SWIGTYPE_p_FooBaz swig_types[2]
...
static void *_p_FooBazTo_p_Foo(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Foo *)  ((FooBaz *) x));
}
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FooBar = {"_p_FooBar", 0, 0, 0, 0, 0};
static swig_type_info _swigt__p_FooBaz = {"_p_FooBaz", 0, 0, 0, 0, 0};
...
static swig_cast_info _swigc__p_FooBaz[] = {{&_swigt__p_FooBaz, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Foo[] = {  {&_swigt__p_Foo, 0, 0, 0},  {&_swigt__p_FooBar, _p_FooBarTo_p_Foo, 0, 0},  {&_swigt__p_FooBaz, _p_FooBazTo_p_Foo, 0, 0},{0, 0, 0, 0}};
...
void _wrap_FooBar_x_set(void* imarg1, int imarg2)
{
  FooBar *arg1 = 0 ;
  int arg2 ;
...
int _wrap_FooBar_x_get(void* imarg1)
{
  FooBar *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_FooBar_vmethod(void* imarg1, int imarg2)
{
  FooBar *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
...
void* _wrap_new_FooBaz()
{
  void* imresult = 0 ;
  FooBaz *result = 0 ;
  
  result = (FooBaz *)new FooBaz();
...
void _wrap_delete_FooBaz(void* imarg1)
{
  FooBaz *arg1 = 0 ;
...
void* SWIG_ObjectiveC_cast__p_FooBaz_to__p_Foo(void* imarg1) {
#ifdef __cplusplus
  return (void*)((Foo *)((FooBaz *)imarg1));
#else
  return imarg1;
#endif
}
