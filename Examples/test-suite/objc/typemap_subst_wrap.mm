...
#define SWIGTYPE_p_p_p_xyzzy swig_types[0]
#define SWIGTYPE_p_p_xyzzy swig_types[1]
#define SWIGTYPE_p_xyzzy swig_types[2]
...
static swig_type_info _swigt__p_p_p_xyzzy = {"_p_p_p_xyzzy", "struct xyzzy ***", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_p_xyzzy = {"_p_p_xyzzy", "struct xyzzy **", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_xyzzy = {"_p_xyzzy", "struct xyzzy *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_p_p_xyzzy[] = {  {&_swigt__p_p_p_xyzzy, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_p_xyzzy[] = {  {&_swigt__p_p_xyzzy, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_xyzzy[] = {  {&_swigt__p_xyzzy, 0, 0, 0},{0, 0, 0, 0}};
...
void _wrap_xyzzy_member_set(void* imarg1, int imarg2)
{
  struct xyzzy *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct xyzzy *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1) (arg1)->member = arg2;
}

int _wrap_xyzzy_member_get(void* imarg1)
{
  struct xyzzy *arg1 = 0 ;
  int imresult = 0 ;
  int result;
  ...
  arg1 = (struct xyzzy *)imarg1; 
  result = (int) ((arg1)->member);
  imresult = result; 
  return imresult;
}

void* _wrap_new_xyzzy()
{
  void* imresult = 0 ;
  struct xyzzy *result = 0 ;
  
  result = (struct xyzzy *)calloc(1, sizeof(struct xyzzy));
...
void _wrap_delete_xyzzy(void* imarg1)
{
  struct xyzzy *arg1 = 0 ;
...
void _wrap_foo(void* imarg1)
{
  struct xyzzy const **temp1 ;
  struct xyzzy const *startemp1 ;
  struct xyzzy const ***amptemp1 ;
  struct xyzzy basetemp1 ;
  struct xyzzy **arg1 = 0 ;
  struct xyzzy const **temp10 ;
  struct xyzzy const *startemp10 ;
  struct xyzzy const ***amptemp10 ;
  struct xyzzy basetemp10 ;
  
  {
    {
      /* Test C type name substitutions */
      struct xyzzy ** a = (struct xyzzy **) NULL;
      const struct xyzzy **b = (struct xyzzy const **) NULL;
      struct xyzzy *** c = (struct xyzzy ***) NULL;
      const struct xyzzy ***d = (struct xyzzy const ***) NULL;
      struct xyzzy * e = *a;
      struct xyzzy f;
      f.member = 42;
      (void)a;
    ...
    {
      /* Test descriptors */
      void *desc = SWIGTYPE_p_p_xyzzy;
      void *stardesc = SWIGTYPE_p_xyzzy;
      void *ampdesc = SWIGTYPE_p_p_p_xyzzy;
      (void)desc;
      (void)stardesc;
      (void)ampdesc;
    }
    ...
    arg1 = (struct xyzzy **) temp10;  
  }
  foo((struct xyzzy const **)arg1);
}
