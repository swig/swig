...
#define SWIGTYPE_p_f_int__int swig_types[0]
...
static swig_type_info _swigt__p_f_int__int = {"_p_f_int__int", "UnaryOp *|int (*)(int)", 0, 0, (void*)0, 0};
...
void _wrap_test3_set(int imarg1)
{
  int arg1 ;
...
int _wrap_do_unary(int imarg1, void* imarg2)
{
  Integer arg1 ;
  UnaryOp *arg2 = 0 ;
  int imresult = 0 ;
  ...
  arg1 = (Integer)imarg1; 
  arg2 = (UnaryOp *)imarg2; 
  result = (Integer)do_unary(arg1,arg2);
  imresult = result; 
  return imresult;
}

int _wrap_negate(int imarg1)
{
  int arg1 ;
  int imresult = 0 ;
  int result;
