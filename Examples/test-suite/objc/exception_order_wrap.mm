...
void _wrap_efoovar_set(int imarg1)
{
  int arg1 ;
...
void _wrap_foovar_set(int imarg1)
{
  int arg1 ;
...
void _wrap_delete_E3(void* imarg1)
{
  E3 *arg1 = 0 ;
...
void _wrap_A_sfoovar_set(int imarg1)
{
  int arg1 ;
...
void _wrap_A_foovar_set(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
...
int _wrap_A_foovar_get(void* imarg1)
{
  A *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void _wrap_A_efoovar_set(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
...
int _wrap_A_efoovar_get(void* imarg1)
{
  A *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_A_foobar(void* imarg1)
{
  A *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
int _wrap_A_barfoo(void* imarg1, int imarg2)
{
  A *arg1 = 0 ;
  int arg2 ;
  int imresult = 0 ;
  ...
  arg2 = (int)imarg2; 
  {
    try {
      try {
        ...
        (void)_e;
        SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ ET< int > exception thrown");
        return 0; 
      } catch(ET< double > &_e) {
        (void)_e;
        SWIG_ObjcThrowException(SWIG_ObjcRuntimeException, "C++ ET< double > exception thrown");
        return 0; 
      } catch(...) {
...
void _wrap_delete_ET_i(void* imarg1)
{
  ET< int > *arg1 = 0 ;
...
void _wrap_delete_ET_d(void* imarg1)
{
  ET< double > *arg1 = 0 ;
  
  arg1 = (ET< double > *)imarg1; 
  {
    try {
      delete arg1;
    } catch(...) {
