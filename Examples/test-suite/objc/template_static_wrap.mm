...
void _wrap_foo_i_test_set(int imarg1)
{
  int arg1 ;
...
int _wrap_foo_i_test_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)foo< int >::test;
  imresult = result; 
  return imresult;
}
...
void _wrap_foo_d_test_set(int imarg1)
{
  int arg1 ;
  
  arg1 = (int)imarg1; 
  foo< double >::test = arg1;
}

int _wrap_foo_d_test_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)foo< double >::test;
  imresult = result; 
  return imresult;
}
...
void _wrap_Foo_test_set(int imarg1)
{
  int arg1 ;
...
int _wrap_Foo_test_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)toto::Foo::test;
  imresult = result; 
  return imresult;
}

double _wrap_Foo_bar_double(int imarg1)
{
  int arg1 ;
  double imresult = 0 ;
  double result;
  ...
  arg1 = (int)imarg1; 
  result = (double)toto::Foo::SWIGTEMPLATEDISAMBIGUATOR bar< double >(arg1);
  imresult = result; 
  return imresult;
}
