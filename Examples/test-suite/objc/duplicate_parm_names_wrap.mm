...
void _wrap_fn_2parms(int imarg1, int imarg2)
{
  int arg1 ;
  int arg2 ;
...
void _wrap_fn_3parms(int imarg1, int imarg2, double imarg3)
{
  int arg1 ;
  int arg2 ;
  double arg3 ;
  ...
  arg2 = (int)imarg2; 
  arg3 = (double)imarg3; 
  fn_3parms(arg1,arg2,arg3);
}

void _wrap_fn_4parms(int imarg1, short imarg2, double imarg3, NSString * imarg4)
{
  int arg1 ;
  short arg2 ;
  double arg3 ;
  ...
  fn_4parms(arg1,arg2,arg3,(char const *)arg4);
}

void _wrap_SameParmNameCheck_metho(void* imarg1, int imarg2, short imarg3, double imarg4, NSString * imarg5)
{
  SameParmNameCheck *arg1 = 0 ;
  int arg2 ;
  short arg3 ;
  double arg4 ;
  char *arg5 = 0 ;
  
  arg1 = (SameParmNameCheck *)imarg1; 
  arg2 = (int)imarg2; 
  arg3 = (short)imarg3; 
  arg4 = (double)imarg4; 
  {
    {
      arg5 = 0;
      if (imarg5) {
        const char *utf8 = [imarg5 UTF8String];
        if (utf8) {
          size_t length = strlen(utf8);
          char *buffer = (char*)malloc(length + 1);
          if (buffer) {
  ...
  (arg1)->metho(arg2,arg3,arg4,(char const *)arg5);
}

void* _wrap_new_SameParmNameCheck()
{
  void* imresult = 0 ;
  SameParmNameCheck *result = 0 ;
  
  result = (SameParmNameCheck *)new SameParmNameCheck();
...
void _wrap_delete_SameParmNameCheck(void* imarg1)
{
  SameParmNameCheck *arg1 = 0 ;
