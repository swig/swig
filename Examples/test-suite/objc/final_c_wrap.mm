...
void _wrap_Y_yval_set(void* imarg1, int imarg2)
{
  struct Y *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct Y *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1) (arg1)->yval = arg2;
}

int _wrap_Y_yval_get(void* imarg1)
{
  struct Y *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_Y()
{
  ...
  result = (struct Y *)calloc(1, sizeof(struct Y));
...
void _wrap_final_set(void* imarg1)
{
  struct Y *arg1 = 0 ;
...
void* _wrap_final_get()
{
  void* imresult = 0 ;
  struct Y *result = 0 ;
  
  result = (struct Y *)&final;
