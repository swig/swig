...
#include "import_fragments_wrap.h"
...
void* _wrap_new_TemplateA4Int()
{
  void* imresult = 0 ;
  TemplateA4< int > *result = 0 ;
  
  result = (TemplateA4< int > *)new TemplateA4< int >();
...
void _wrap_delete_TemplateA4Int(void* imarg1)
{
  TemplateA4< int > *arg1 = 0 ;
  
  arg1 = (TemplateA4< int > *)imarg1; 
  delete arg1;
}

int _wrap_getImport4()
{
  int imresult = 0 ;
  int result;
  
  result = (int)getImport4();
  imresult = result; 
  return imresult;
}
