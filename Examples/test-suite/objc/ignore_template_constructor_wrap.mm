...
SWIGINTERN std::vector< Flow >::const_reference std_vector_Sl_Flow_Sg__get(std::vector< Flow > *self,int i){
...
SWIGINTERN void std_vector_Sl_Flow_Sg__set(std::vector< Flow > *self,int i,std::vector< Flow >::value_type const &val){
                int size = int(self->size());
                if (i>=0 && i<size)
                    (*self)[i] = val;
                else
...
void _wrap_delete_Flow(void* imarg1)
{
  Flow *arg1 = 0 ;
...
void* _wrap_new_VectFlow()
{
  void* imresult = 0 ;
  std::vector< Flow > *result = 0 ;
  
  result = (std::vector< Flow > *)new std::vector< Flow >();
...
unsigned long _wrap_VectFlow_size(void* imarg1)
{
  std::vector< Flow > *arg1 = 0 ;
  unsigned long imresult = 0 ;
  std::vector< Flow >::size_type result;
  
  arg1 = (std::vector< Flow > *)imarg1; 
  result = ((std::vector< Flow > const *)arg1)->size();
  imresult = result; 
  return imresult;
}

unsigned long _wrap_VectFlow_capacity(void* imarg1)
{
  std::vector< Flow > *arg1 = 0 ;
  unsigned long imresult = 0 ;
  std::vector< Flow >::size_type result;
  ...
  arg1 = (std::vector< Flow > *)imarg1; 
  result = ((std::vector< Flow > const *)arg1)->capacity();
  imresult = result; 
  return imresult;
}

void _wrap_VectFlow_reserve(void* imarg1, unsigned long imarg2)
{
  std::vector< Flow > *arg1 = 0 ;
  std::vector< Flow >::size_type arg2 ;
  
  arg1 = (std::vector< Flow > *)imarg1; 
  arg2 = (std::vector< Flow >::size_type)imarg2; 
  (arg1)->reserve(SWIG_STD_MOVE(*(&arg2)));
}

BOOL _wrap_VectFlow_isEmpty(void* imarg1)
{
  std::vector< Flow > *arg1 = 0 ;
  BOOL imresult = 0 ;
  bool result;
  ...
  arg1 = (std::vector< Flow > *)imarg1; 
  result = (bool)((std::vector< Flow > const *)arg1)->empty();
  imresult = (result)? YES:NO; 
  return imresult;
}

void _wrap_VectFlow_clear(void* imarg1)
{
  std::vector< Flow > *arg1 = 0 ;
...
void _wrap_VectFlow_add(void* imarg1, void* imarg2)
{
  std::vector< Flow > *arg1 = 0 ;
  std::vector< Flow >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< Flow > *)imarg1; 
  arg2 = (std::vector< Flow >::value_type *)imarg2; 
  (arg1)->push_back((std::vector< Flow >::value_type const &)*arg2);
}

void* _wrap_VectFlow_get(void* imarg1, int imarg2)
{
  std::vector< Flow > *arg1 = 0 ;
  int arg2 ;
  void* imresult = 0 ;
  std::vector< Flow >::value_type *result = 0 ;
  
  arg1 = (std::vector< Flow > *)imarg1; 
  arg2 = (int)imarg2; 
  try {
    result = (std::vector< Flow >::value_type *) &std_vector_Sl_Flow_Sg__get(arg1,arg2);
...
void _wrap_VectFlow_set(void* imarg1, int imarg2, void* imarg3)
{
  std::vector< Flow > *arg1 = 0 ;
  int arg2 ;
  std::vector< Flow >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< Flow > *)imarg1; 
  arg2 = (int)imarg2; 
  arg3 = (std::vector< Flow >::value_type *)imarg3; 
  try {
    std_vector_Sl_Flow_Sg__set(arg1,arg2,(Flow const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_ObjcThrowException(SWIG_ObjcIndexOutOfBoundsException, (&_e)->what());
    return ;
  }
...
void _wrap_delete_VectFlow(void* imarg1)
{
  std::vector< Flow > *arg1 = 0 ;
...
void* _wrap_inandout(void* imarg1)
{
  std::vector< Flow > *argp1 ;
  std::vector< Flow > arg1 ;
  void* imresult = 0 ;
  std::vector< Flow > *argp10 ;
  std::vector< Flow > *temp ;
  std::vector< Flow > result;
  
  
  argp10 = (std::vector< Flow > *)imarg1;
  arg1 = *argp10;
  
  result = inandout(SWIG_STD_MOVE(*(&arg1)));
  
  temp = new std::vector< Flow >((const std::vector< Flow > &)result);
  imresult = (void*)temp;
