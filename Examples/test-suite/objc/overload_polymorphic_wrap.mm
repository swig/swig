...
int _wrap_test2(void* imarg1)
{
  ...
  arg1 = (UnknownClass *)imarg1; 
  result = (int)test2(arg1);
  imresult = result; 
  return imresult;
}

int _wrap_test3(NSString * imarg1, void* imarg2, BOOL imarg3)
{
  char *arg1 = 0 ;
  Base *arg2 = 0 ;
  bool arg3 ;
  ...
  result = (int)test3((char const *)arg1,(Base const *)arg2,arg3);
  imresult = result; 
  return imresult;
}
