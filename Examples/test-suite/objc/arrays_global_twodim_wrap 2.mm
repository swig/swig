...
#define SWIGTYPE_p_finger swig_types[1]
...
{
  Material *(*arg1)[Size] = (Material *(*)[Size])0 ;
  
  arg1 = (Material *(*)[Size])imarg1; 
  {
    Material const * (*inp)[Size] = (Material const * (*)[Size])(arg1);
    Material const * (*dest)[Size] = (Material const * (*)[Size])(chitMat);
    size_t ii = 0;
    for (; ii < Size; ++ii) {
      Material const * *ip = inp[ii];
      Material const * *dp = dest[ii];
      size_t jj = 0;
      for (; jj < Size; ++jj) dp[jj] = ip[jj];
    }
  }
}
...
{
  void* imresult = 0 ;
  Material *(*result)[Size] = 0 ;
  
  result = (Material *(*)[Size])(Material *(*)[Size])chitMat;
  imresult = result; 
  return imresult;
}
...
void _wrap_hitMat_val_set(void* imarg1)
{
  ...
  arg1 = (Material (*)[Size])imarg1; 
  {
    Material (*inp)[Size] = (Material (*)[Size])(arg1);
    Material (*dest)[Size] = (Material (*)[Size])(hitMat_val);
    size_t ii = 0;
    for (; ii < Size; ++ii) {
      Material *ip = inp[ii];
      Material *dp = dest[ii];
...
void* _wrap_hitMat_val_get()
{
  ...
  result = (Material (*)[Size])(Material (*)[Size])hitMat_val;
  imresult = result; 
  return imresult;
}
...
void _wrap_hitMat_set(void* imarg1)
{
  ...
  {
    Material * (*inp)[Size] = (Material * (*)[Size])(arg1);
    Material * (*dest)[Size] = (Material * (*)[Size])(hitMat);
    size_t ii = 0;
    for (; ii < Size; ++ii) {
      Material * *ip = inp[ii];
      Material * *dp = dest[ii];
...
void* _wrap_hitMat_get()
{
  ...
  result = (Material *(*)[Size])(Material *(*)[Size])hitMat;
  imresult = result; 
  return imresult;
}
