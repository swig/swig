...
void* _wrap_new_A_Hi(int imarg1)
{
  int arg1 ;
  void* imresult = 0 ;
  A< Hi > *result = 0 ;
...
void* _wrap_B_Hola_get_c(void* imarg1)
{
  B< Hola > *arg1 = 0 ;
  void* imresult = 0 ;
  C *temp ;
  SwigValueWrapper< C > result;
  
  arg1 = (B< Hola > *)imarg1; 
  result = (arg1)->get_c();
  
  temp = new C((const C &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_B_Hola_get_a(void* imarg1)
{
  B< Hola > *arg1 = 0 ;
  void* imresult = 0 ;
  A< Hola > *temp ;
  SwigValueWrapper< A< Hola > > result;
  
  arg1 = (B< Hola > *)imarg1; 
  result = (arg1)->get_a();
  
  temp = new A< Hola >((const A< Hola > &)result);
  imresult = (void*)temp;
  
  return imresult;
}

void* _wrap_new_B_Hola()
{
  void* imresult = 0 ;
  B< Hola > *result = 0 ;
  
  result = (B< Hola > *)new B< Hola >();
...
void _wrap_delete_B_Hola(void* imarg1)
{
  B< Hola > *arg1 = 0 ;
