...
NSString* _wrap_non_utf8_std_string()
{
  NSString* imresult = 0 ;
  std::string result;
  
  result = non_utf8_std_string();
  imresult = [NSString stringWithUTF8String: (&result)->c_str()]; 
  return imresult;
}

NSString * _wrap_charstring(NSString * imarg1)
{
  char *arg1 = 0 ;
  NSString * imresult = 0 ;
  char *result = 0 ;
  ...
  result = (char *)charstring(arg1);
  if (result) imresult = [NSString stringWithUTF8String: (const char*)result]; 
  return imresult;
}

void _wrap_instring(NSString * imarg1)
{
  char *arg1 = 0 ;
