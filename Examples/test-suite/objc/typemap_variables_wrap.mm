...
void _wrap_globul_set(int imarg1)
{
  int arg1 ;
  
  /*int globul in */ arg1=0;
  globul = arg1;
}

int _wrap_globul_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)globul;
  /*int globul out*/ imresult=OUT_NULL_VALUE;
  return imresult;
}

void _wrap_nspace_set(int imarg1)
{
  int arg1 ;
  
  /*int nspace in */ arg1=0;
  Space::nspace = arg1;
}

int _wrap_nspace_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)Space::nspace;
  /*int nspace out*/ imresult=OUT_NULL_VALUE;
  return imresult;
}

void _wrap_Struct_member_set(void* imarg1, int imarg2)
{
  Space::Struct *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (Space::Struct *)imarg1; 
  /*int member in */ arg2=0;
  if (arg1) (arg1)->member = arg2;
}

int _wrap_Struct_member_get(void* imarg1)
{
  Space::Struct *arg1 = 0 ;
  int imresult = 0 ;
  int result;
  ...
  /*int member out*/ imresult=OUT_NULL_VALUE;
  return imresult;
}

void _wrap_Struct_smember_set(int imarg1)
{
  int arg1 ;
  
  /*int smember in */ arg1=0;
  Space::Struct::smember = arg1;
}

int _wrap_Struct_smember_get()
{
  int imresult = 0 ;
  int result;
  
  result = (int)Space::Struct::smember;
  /*int smember out*/ imresult=OUT_NULL_VALUE;
  return imresult;
}
...
{
  void* imresult = 0 ;
  Space::Struct *result = 0 ;
  
  result = (Space::Struct *)new Space::Struct();
