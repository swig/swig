...
void _wrap_NotALotHere_n_set(void* imarg1, int imarg2)
{
  struct NotALotHere *arg1 = 0 ;
  int arg2 ;
  
  arg1 = (struct NotALotHere *)imarg1; 
  arg2 = (int)imarg2; 
  if (arg1) (arg1)->n = arg2;
}

int _wrap_NotALotHere_n_get(void* imarg1)
{
  struct NotALotHere *arg1 = 0 ;
  int imresult = 0 ;
  int result;
...
void* _wrap_new_NotALotHere()
{
  void* imresult = 0 ;
  struct NotALotHere *result = 0 ;
  
  result = (struct NotALotHere *)calloc(1, sizeof(struct NotALotHere));
...
void _wrap_delete_NotALotHere(void* imarg1)
{
  struct NotALotHere *arg1 = 0 ;
