...
// Try the variables
check("Square area ", 100.0, /* await */(member_pointer_const.do_op(s, member_pointer_const.areavar)));
check("Square perim", 40.0, /* await */(member_pointer_const.do_op(s, member_pointer_const.perimetervar)));
...
check("Square area ", 100.0, /* await */(member_pointer_const.do_op(s, member_pointer_const.AREAPT)));
check("Square perim", 40.0, /* await */(member_pointer_const.do_op(s, member_pointer_const.PERIMPT)));

// Typedefs
check("Square perim", 40.0, /* await */(member_pointer_const.do_op_td(s, perim_pt)));

check("Add by value", 3, /* await */(member_pointer_const.call1(member_pointer_const.ADD_BY_VALUE, 1, 2)));
