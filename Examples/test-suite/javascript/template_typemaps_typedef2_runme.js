...
var dummy_pair = /* await */(m1.make_dummy_pair());
var val = (/* await */(m1.typemap_test(dummy_pair))).val;
if (val != 1234) {
...
if ((/* await */(template_typemaps_typedef2.typedef_test1(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef2.typedef_test1 not working");
}

if ((/* await */(template_typemaps_typedef2.typedef_test2(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef2.typedef_test2 not working");
}

if ((/* await */(template_typemaps_typedef2.typedef_test3(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef2.typedef_test3 not working");
}

if ((/* await */(template_typemaps_typedef2.typedef_test4(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef2.typedef_test4 not working");
}

if ((/* await */(template_typemaps_typedef2.typedef_test5(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef2.typedef_test5 not working");
}

if ((/* await */(template_typemaps_typedef2.typedef_test6(dummy_pair))).val != 1234) {
