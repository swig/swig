...
check(/* await */(li_std_pair.product1(intPair)) === 42);
check(/* await */(li_std_pair.product2(intPair)) === 42);
...
check(/* await */(li_std_pair.product1(intPairPtr)) === 42);
check(/* await */(li_std_pair.product2(intPairPtr)) === 42);
check(/* await */(li_std_pair.product3(intPairPtr)) === 42);
