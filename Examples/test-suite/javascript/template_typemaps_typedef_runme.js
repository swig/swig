...
if ((/* await */(template_typemaps_typedef.typedef_test1(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef.typedef_test1 not working");
}

if ((/* await */(template_typemaps_typedef.typedef_test2(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef.typedef_test2 not working");
}

if ((/* await */(template_typemaps_typedef.typedef_test3(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef.typedef_test3 not working");
}

if ((/* await */(template_typemaps_typedef.typedef_test4(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef.typedef_test4 not working");
}

if ((/* await */(template_typemaps_typedef.typedef_test5(dummy_pair))).val != 1234) {
    throw new Error("template_typemaps_typedef.typedef_test5 not working");
}

if ((/* await */(template_typemaps_typedef.typedef_test6(dummy_pair))).val != 1234) {
