@file:JvmName("multiple_inheritance_nspace_runme")
...
fun jcbase1b(cb1: CBase1SwigInterface): Int {
    return cb1.cbase1y()
}
fun jabase1(ab1: ABase1SwigInterface): Int {
    return ab1.abase1()
}
fun jcbase2(cb2: CBase2SwigInterface): Int {
    return cb2.cbase2()
}
...
fun main() {
    ...
    val cb3: CBase1SwigInterface = Derived1()
    val cb4: CBase1SwigInterface = Derived3()
    val cb5: CBase2SwigInterface = Derived3()
    val ab6: ABase1SwigInterface = Derived2()
    ...
    check(jcbase1b(d1) != 3, "jcbase1b() through Derived1 as parameter failed")
    check(jcbase1b(d2) != 6, "jcbase1b() through Derived2 as parameter failed")
    check(jcbase1b(d3) != 7, "jcbase1b() through Derived3 as parameter failed")
    check(jcbase2(d1) != 4, "jcbase2() through Derived1 as parameter failed")
    check(jcbase2(d3) != 8, "jcbase2() through Derived3 as parameter failed")
    check(jabase1(d2) != 5, "jabase1() through Derived2 as parameter failed")
    check(jabase1(d3) != 9, "jabase1() through Derived3 as parameter failed")
