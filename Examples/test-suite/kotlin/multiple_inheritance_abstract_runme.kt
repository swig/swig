@file:JvmName("multiple_inheritance_abstract_runme")
...
fun jcbase1b(cb1: CBase1): Int {
    return cb1.cbase1y()
}
fun jabase1(ab1: ABase1): Int {
    return ab1.abase1()
}
fun jcbase2(cb2: CBase2): Int {
    return cb2.cbase2()
}
...
fun main() {
    ...
    val cb3: CBase1 = Derived1()
    val cb4: CBase1 = Derived3()
    val cb5: CBase2 = Derived3()
    val ab6: ABase1 = Derived2()
