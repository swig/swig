...
class director_wombat_Bar_derived_1 : Bar() {
    override fun foo_meth_ref(arg0: Foo_integers, arg1: Int) {
        if (arg0 !is director_wombat_Foo_integers_derived_2) {
            throw RuntimeException("Test failed: arg0 in foo_meth_ref is not director_wombat_Foo_integers_derived_2, got " + arg0)
        }
    }

    override fun foo_meth_ptr(arg0: Foo_integers?, arg1: Int) {
        if (arg0 !is director_wombat_Foo_integers_derived_2) {
            throw RuntimeException("Test failed: arg0 in foo_meth_ptr is not director_wombat_Foo_integers_derived_2, got " + arg0)
        }
    }

    override fun foo_meth_val(arg0: Foo_integers, arg1: Int) {
        if (arg0 !is director_wombat_Foo_integers_derived_2) {
            throw RuntimeException("Test failed: arg0 in foo_meth_val is not director_wombat_Foo_integers_derived_2, got " + arg0)
        }
    }
}
