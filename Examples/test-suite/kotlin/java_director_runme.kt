@file:JvmName("java_director_runme")
...
class java_director_MyQuux(arg: String) : Quux(arg) {
...
fun createContainer(): QuuxContainer {
    ...
    qc.push(java_director_MyQuux("element 2"))
    qc.push(java_director_MyQuux("element 3"))
