@file:JvmName("cpp20_concepts_extra_runme")
...
fun main() {
    ...
    if (cpp20_concepts_extra.succ_int(5) != 6)
        throw RuntimeException("succ_int(5)")

    // Trailing requires-clause on a non-template member of a class template.
    val h = ConstrainedHolderInt(4)
    if (h.cube() != 64)
        throw RuntimeException("ConstrainedHolderInt.cube")
}
