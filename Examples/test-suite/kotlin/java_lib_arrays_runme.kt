@file:JvmName("java_lib_arrays_runme")
...
fun main() {
    ...
    if (java_lib_arrays.extract_ptr(array_yet_another_struct, 0) != 222.333) throw RuntimeException("extract_ptr 0 failed")
    if (java_lib_arrays.extract_ptr(array_yet_another_struct, 1) != 444.555) throw RuntimeException("extract_ptr 1 failed")

    java_lib_arrays.modifyYAS(array_yet_another_struct, array_yet_another_struct.size)
    for (i in 0 until 2) {
