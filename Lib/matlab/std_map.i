...
%fragment("StdMapCommonTraits","header",fragment="StdSequenceTraits")
{
  namespace swig {
    ...
    {
      OctMapIterator_T(OutIterator curr, OutIterator first, OutIterator last, matlab_value seq)
    ...
    {
      OctMapKeyIterator_T(OutIterator curr, OutIterator first, OutIterator last, matlab_value seq)
    ...
    {
      OctMapValueIterator_T(OutIterator curr, OutIterator first, OutIterator last, matlab_value seq)
	: OctMapIterator_T<OutIterator, FromOper>(curr, first, last, seq)
      {
      }
    };
...
%fragment("StdMapTraits","header",fragment="StdMapCommonTraits")
{
  namespace swig {
    ...
    inline void
    assign(const OctSeq& matseq, std::map<K,T > *map) {
      typedef typename std::map<K,T>::value_type value_type;
      typename OctSeq::const_iterator it = matseq.begin();
