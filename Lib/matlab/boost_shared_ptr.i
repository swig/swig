...
%fragment("SWIG_null_deleter_matlab", "header", fragment="SWIG_null_deleter") {
...
%typemap(out, fragment="SWIG_null_deleter_matlab") CONST TYPE * {
...
%typemap(varout, fragment="SWIG_null_deleter_matlab") CONST TYPE * {
...
%typemap(out, fragment="SWIG_null_deleter_matlab") TYPE *CONST& {
  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *smartresult = new SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >(*$1 SWIG_NO_NULL_DELETER_$owner);
  %set_output(SWIG_NewPointerObj(%as_voidptr(smartresult), $descriptor(SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< TYPE > *), SWIG_POINTER_OWN));
}
