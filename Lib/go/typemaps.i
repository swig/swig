...
INPUT_TYPEMAP(int, int32);
INPUT_TYPEMAP(unsigned int, uint32);
INPUT_TYPEMAP(long, int32);
INPUT_TYPEMAP(unsigned long, uint32);
...
OUTPUT_TYPEMAP(int, int32);
OUTPUT_TYPEMAP(unsigned int, uint32);
OUTPUT_TYPEMAP(long, int32);
OUTPUT_TYPEMAP(unsigned long, uint32);
...
INOUT_TYPEMAP(int, int32);
INOUT_TYPEMAP(unsigned int, uint32);
INOUT_TYPEMAP(long, int32);
INOUT_TYPEMAP(unsigned long, uint32);
