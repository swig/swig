...
SWIG_STD_VECTOR_ENHANCED(ptrdiff_t)
SWIG_STD_VECTOR_ENHANCED(int8_t)
SWIG_STD_VECTOR_ENHANCED(uint8_t)
SWIG_STD_VECTOR_ENHANCED(int16_t)
SWIG_STD_VECTOR_ENHANCED(uint16_t)
SWIG_STD_VECTOR_ENHANCED(int32_t)
SWIG_STD_VECTOR_ENHANCED(uint32_t)
SWIG_STD_VECTOR_ENHANCED(int64_t)
SWIG_STD_VECTOR_ENHANCED(uint64_t)
