...
%typemap(ktype) char **STRING_ARRAY "Array<String>"
%typemap(kstype) char **STRING_ARRAY "Array<String>"
...
%typemap(ktype) char **STRING_OUT "Array<String>"
%typemap(kstype) char **STRING_OUT "Array<String>"
%typemap(kin) char **STRING_OUT "$kotlininput"
...
%typemap(ktype) char *BYTE "ByteArray"
%typemap(kstype) char *BYTE "ByteArray"
...
%typemap(kin) char *BYTE "$kotlininput"
