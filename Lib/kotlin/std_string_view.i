...
%typemap(ktype) string_view "String"
%typemap(kstype) string_view "String"
%typemap(kdirectorin) string_view "$jniinput"
%typemap(kdirectorout) string_view "$kotlincall"
...
%typemap(ktype) const string_view & "String"
%typemap(kstype) const string_view & "String"
%typemap(kdirectorin) const string_view & "$jniinput"
%typemap(kdirectorout) const string_view & "$kotlincall"
