...
%typemap (ktype)  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE >,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > &,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *& "Long"
%typemap (kstype) SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE >,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > &,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *,
                  SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *& "$typemap(kstype, TYPE)?"
%typemap(kin) SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE >,
                 SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                 SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > &,
                 SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *,
                 SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > *& "$typemap(kstype, TYPE).getCPtr($kotlininput)"

%typemap(kout) SWIG_INTRUSIVE_PTR_QNAMESPACE::intrusive_ptr< CONST TYPE > {
    val cPtr = $jnicall
...
%typemap(kbody) TYPE %{
  ...
  PTRCTOR_VISIBILITY $kotlinclassname(long cPtr, boolean cMemoryOwn) {
    swigCMemOwnBase = cMemoryOwn;
    swigCPtr = cPtr;
  }

  CPTR_VISIBILITY static long getCPtr($kotlinclassname obj) {
...
%typemap(kbody_derived) TYPE %{
  ...
  PTRCTOR_VISIBILITY $kotlinclassname(long cPtr, boolean cMemoryOwn) {
    super($imclassname.$kotlinclazznameSWIGSmartPtrUpcast(cPtr), true);
...
%typemap(ktype, nopgcpp="1") SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< TYPE > swigSharedPtrUpcast "Long"
%typemap(ktype, nopgcpp="1") SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > swigSharedPtrUpcast "Long"
...
%typemap (ktype)  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > "Long"
%typemap (kstype) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > "$typemap(kstype, TYPE)?"
%typemap (kin) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > "$typemap(kstype, TYPE).getCPtr($kotlininput)"
%typemap(kout) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > {
    val cPtr = $jnicall
    return if (cPtr == 0L) null else $typemap(kstype, TYPE)(cPtr, true)
  }
