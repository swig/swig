...
%typemap(ktype)   (const void *BYTES, size_t LENGTH) "ByteArray"
%typemap(kstype)  (const void *BYTES, size_t LENGTH) "ByteArray"
%typemap(kin)  (const void *BYTES, size_t LENGTH) "$kotlininput"
...
%typemap(kdirectorin, descriptor="[B") (const void *BYTES, size_t LENGTH) "$jniinput"
...
%typemap(ktype) SWIGCDATA "ByteArray"
%typemap(kstype) SWIGCDATA "ByteArray"
