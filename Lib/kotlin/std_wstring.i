...
%typemap(ktype) wstring "String"
%typemap(kstype) wstring "String"
%typemap(kdirectorin) wstring "$jniinput"
%typemap(kdirectorout) wstring "$kotlincall"
...
%typemap(ktype) const wstring & "String"
%typemap(kstype) const wstring & "String"
%typemap(kdirectorin) const wstring & "$jniinput"
%typemap(kdirectorout) const wstring & "$kotlincall"
