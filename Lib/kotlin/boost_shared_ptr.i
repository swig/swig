...
%typemap(directorin,descriptor="L$packagepath/$&kotlinclassname;") CONST TYPE
%{ $input = 0;
...
%typemap(directorin,descriptor="L$packagepath/$*kotlinclassname;") TYPE *CONST&
%{ $input = 0;
  if ($1) {
    *((SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > **)&$input) = new SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > ($1 SWIG_NO_NULL_DELETER_0);
 } %}
...
%typemap(directorin,descriptor="L$packagepath/$typemap(kstype, TYPE);") SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >
%{ $input = 0;
  if ($1) {
...
%typemap (ktype)  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > &,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *& "Long"
%typemap (kstype) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > &,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *,
                  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *& "$typemap(kstype, TYPE)?"

%typemap(kin) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                 SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > &,
                 SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *,
                 SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *& "$typemap(kstype, TYPE).getCPtr($kotlininput)"

%typemap(kout) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > {
    val cPtr = $jnicall
...
%typemap(kout) TYPE *CONST& {
    val cPtr = $jnicall
    return if (cPtr == 0L) null else $typemap(kstype, TYPE)(cPtr, true)
  }

%typemap(kdirectorout) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > "$typemap(kstype, TYPE).getCPtr($kotlincall)"

%typemap(kdirectorin) CONST TYPE,
                         CONST TYPE *,
                         CONST TYPE &,
                         TYPE *CONST& "if ($jniinput == 0L) null else $typemap(kstype, TYPE)($jniinput, true)"

%typemap(kdirectorin) SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >,
                         SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > &,
                         SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *,
                         SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *& "if ($jniinput == 0L) null else $typemap(kstype, TYPE)($jniinput, true)"
...
%typemap(kcompanion) TYPE %{
    CPTR_VISIBILITY fun getCPtr(obj: $kotlinclassname?): Long {
      return if (obj == null) 0L else obj.swigCPtr
    }
%}

// Derived proxy classes
%typemap(kbody_derived) TYPE %{
  private var swigCPtr: Long
  private var swigCMemOwnDerived: Boolean

  PTRCTOR_VISIBILITY constructor(cPtr: Long, cMemoryOwn: Boolean) : super($imclassname.$kotlinclazznameSWIGSmartPtrUpcast(cPtr), true) {
...
%typemap(kcompanion_derived) TYPE %{
    CPTR_VISIBILITY fun getCPtr(obj: $kotlinclassname?): Long {
      return if (obj == null) 0L else obj.swigCPtr
    }
%}

%typemap(kdestruct, methodname="delete", methodmodifiers="@Synchronized open") TYPE {
    if (swigCPtr != 0L) {
      if (swigCMemOwn) {
        swigCMemOwn = false
        $jnicall
...
%typemap(kdestruct_derived, methodname="delete", methodmodifiers="@Synchronized override") TYPE {
    if (swigCPtr != 0L) {
