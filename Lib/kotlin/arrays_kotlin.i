...
%define JAVA_ARRAYS_TYPEMAPS(CTYPE, KARRAYTYPE, JNITYPE, JFUNCNAME, JNIDESC)

%typemap(jni) CTYPE[ANY], CTYPE[]               %{JNITYPE##Array%}
%typemap(ktype) CTYPE[ANY], CTYPE[]             %{KARRAYTYPE%}
%typemap(kstype) CTYPE[ANY], CTYPE[]            %{KARRAYTYPE%}
...
%typemap(ktype) ARRAYSOFENUMS[ANY], ARRAYSOFENUMS[] "IntArray"
%typemap(kstype) ARRAYSOFENUMS[ANY], ARRAYSOFENUMS[] "IntArray"
